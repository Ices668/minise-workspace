...
// Source: gkx-prototype/hot-analysis.html
...
<span class="text-slate-400">/</span>
<a class="text-primary hover:underline" href="#">战略咨询报告</a>
<span class="text-slate-400">/</span>
<span class="font-semibold text-slate-600 dark:text-slate-300">热点分析</span>
</nav>
<!-- Page Header -->
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
<h1 class="text-3xl font-black tracking-tight">热点分析</h1>
<div class="flex items-center gap-3">
<button class="inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-primary text-white font-bold text-sm shadow-sm hover:bg-primary/90 transition-colors">
<span class="material-symbols-outlined mr-2 text-[18px]">add_chart</span>
                    生成热点报告
                </button>
<button class="inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-primary/10 text-primary font-bold text-sm border border-primary/20 hover:bg-primary/20 transition-colors">
<span class="material-symbols-outlined mr-2 text-[18px]">add_task</span>
                    新建任务
                </button>
<button class="inline-flex items-center justify-center p-2.5 rounded-lg bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 transition-colors">
<span class="material-symbols-outlined text-[20px]">refresh</span>
</button>
</div>
</div>
<!-- Filter Section -->
<div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 p-6 mb-8">
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
<div class="space-y-2">
<label class="text-xs font-bold text-slate-500 uppercase tracking-wider">热点名称</label>
<div class="relative">
<span class="absolute inset-y-0 left-3 flex items-center text-slate-400">
<span class="material-symbols-outlined text-[18px]">search</span>
</span>
<input class="w-full pl-10 pr-4 py-2 rounded-full border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 focus:ring-primary focus:border-primary text-sm" placeholder="搜索关键词..." type="text"/>
</div>
</div>
<div class="space-y-2">
<label class="text-xs font-bold text-slate-500 uppercase tracking-wider">行业领域</label>
<select class="w-full px-4 py-2 rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 focus:ring-primary focus:border-primary text-sm">
<option>全部领域</option>
<option>人工智能</option>
<option>量子计算</option>
<option>生物医药</option>
...
<div class="space-y-2">
<label class="text-xs font-bold text-slate-500 uppercase tracking-wider">影响等级</label>
<select class="w-full px-4 py-2 rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 focus:ring-primary focus:border-primary text-sm">
<option>所有等级</option>
<option>特高影响</option>
<option>高影响</option>
...
<button class="flex-1 px-6 py-2 rounded-lg bg-primary text-white font-bold text-sm shadow-sm hover:opacity-90">查询</button>
<button class="px-6 py-2 rounded-lg bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 font-bold text-sm hover:bg-slate-200">重置</button>
</div>
</div>
</div>
<!-- Dashboard Section - Stats -->
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-100 dark:border-slate-700 shadow-sm flex items-center justify-between">
<div>
<p class="text-sm font-medium text-slate-500 mb-1">实时识别热点</p>
<p class="text-3xl font-black text-primary">128</p>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-100 dark:border-slate-700 shadow-sm flex items-center justify-between">
<div>
<p class="text-sm font-medium text-slate-500 mb-1">高影响技术事件</p>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-100 dark:border-slate-700 shadow-sm flex items-center justify-between">
<div>
<p class="text-sm font-medium text-slate-500 mb-1">平均情感正向率</p>
<p class="text-3xl font-black text-slate-900 dark:text-white">74.2%</p>
<p class="text-xs text-emerald-500 mt-2 flex items-center">
<span class="material-symbols-outlined text-[14px] mr-1">add</span>
                        稳定增长中
                    </p>
</div>
<div class="h-12 w-12 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-500">
<span class="material-symbols-outlined">sentiment_satisfied</span>
</div>
</div>
</div>
<!-- Analytical Layout - Top Section -->
<div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 p-6 mb-8">
...
<div class="flex items-center gap-1.5"><span class="w-3 h-3 rounded-full bg-primary"></span> 提及声量</div>
<div class="flex items-center gap-1.5"><span class="w-3 h-3 rounded-full bg-emerald-500"></span> 情感指数</div>
</div>
</div>
<div class="h-64 w-full bg-slate-50 dark:bg-slate-900/50 rounded-lg flex items-end justify-between px-8 pb-4 relative overflow-hidden">
<!-- Mock Chart Visual -->
...
<div class="w-6 bg-primary/20 rounded-t h-1/3"></div>
<div class="w-6 bg-primary/40 rounded-t h-1/2"></div>
<div class="w-6 bg-primary/30 rounded-t h-2/5"></div>
<div class="w-6 bg-primary/60 rounded-t h-3/4"></div>
<div class="w-6 bg-primary rounded-t h-full"></div>
<div class="w-6 bg-primary/80 rounded-t h-4/5"></div>
<div class="w-6 bg-primary/50 rounded-t h-1/2"></div>
<div class="w-6 bg-primary/40 rounded-t h-2/3"></div>
<div class="w-6 bg-primary/30 rounded-t h-1/2"></div>
<div class="w-6 bg-primary/20 rounded-t h-1/4"></div>
<div class="w-6 bg-primary/10 rounded-t h-1/6"></div>
<!-- Line Overlay placeholder -->
<svg class="absolute bottom-10 left-0 w-full h-32 text-emerald-500" preserveaspectratio="none">
<path d="M0 60 Q 100 20, 200 70 T 400 40 T 600 80 T 800 20 T 1440 60" fill="none" stroke="currentColor" stroke-width="3"></path>
</svg>
</div>
<div class="flex justify-between mt-4 text-[10px] text-slate-400 font-medium px-2">
<span>08:00</span><span>10:00</span><span>12:00</span><span>14:00</span><span>16:00</span><span>18:00</span><span>20:00</span><span>22:00</span><span>00:00</span>
</div>
</div>
<!-- Analytical Layout - Middle Section -->
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
<!-- Table Section -->
<div class="lg:col-span-2 bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden">
<div class="p-6 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center">
<h3 class="text-lg font-bold flex items-center">
<span class="w-1.5 h-6 bg-primary rounded-full mr-3"></span>
                        热点事件清单
                    </h3>
<button class="text-xs text-primary font-bold hover:underline">查看更多</button>
</div>
<div class="overflow-x-auto">
<table class="w-full text-left">
<thead>
<tr class="bg-slate-50 dark:bg-slate-900/50 text-slate-500 text-xs font-bold uppercase">
<th class="px-6 py-4">热点名称</th>
<th class="px-6 py-4">热度等级</th>
<th class="px-6 py-4">关联技术</th>
<th class="px-6 py-4">爆发时间</th>
<th class="px-6 py-4 text-right">操作</th>
</tr>
</thead>
<tbody class="divide-y divide-slate-100 dark:divide-slate-700">
<tr class="hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
<td class="px-6 py-4 text-sm font-semibold">生成式AI在边缘侧部署突破</td>
<td class="px-6 py-4">
...
<td class="px-6 py-4">
<span class="px-2 py-0.5 rounded bg-primary/10 text-primary text-[10px] font-bold">LLM</span>
</td>
<td class="px-6 py-4 text-xs text-slate-500">2023-11-24 14:20</td>
<td class="px-6 py-4 text-right space-x-3">
<button class="text-primary hover:text-primary/80 font-bold text-xs">详情</button>
<button class="text-slate-400 hover:text-primary font-bold text-xs">报告</button>
</td>
</tr>
<tr class="hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
<td class="px-6 py-4 text-sm font-semibold">第二代高温超导材料应用</td>
<td class="px-6 py-4">
<div class="w-full bg-slate-100 dark:bg-slate-700 rounded-full h-1.5 max-w-[100px]">
...
<td class="px-6 py-4">
<span class="px-2 py-0.5 rounded bg-primary/10 text-primary text-[10px] font-bold">新材料</span>
</td>
<td class="px-6 py-4 text-xs text-slate-500">2023-11-24 09:15</td>
<td class="px-6 py-4 text-right space-x-3">
<button class="text-primary hover:text-primary/80 font-bold text-xs">详情</button>
<button class="text-slate-400 hover:text-primary font-bold text-xs">报告</button>
</td>
...
<tr class="hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
<td class="px-6 py-4 text-sm font-semibold">量子纠错代码效率提升3倍</td>
<td class="px-6 py-4">
<div class="w-full bg-slate-100 dark:bg-slate-700 rounded-full h-1.5 max-w-[100px]">
...
<td class="px-6 py-4">
<span class="px-2 py-0.5 rounded bg-primary/10 text-primary text-[10px] font-bold">量子计算</span>
</td>
<td class="px-6 py-4 text-xs text-slate-500">2023-11-23 22:40</td>
<td class="px-6 py-4 text-right space-x-3">
<button class="text-primary hover:text-primary/80 font-bold text-xs">详情</button>
<button class="text-slate-400 hover:text-primary font-bold text-xs">报告</button>
</td>
...
<div class="relative h-64 bg-slate-50 dark:bg-slate-900/50 rounded-lg flex items-center justify-center overflow-hidden">
<div class="absolute inset-0 opacity-20" style="background-image: radial-gradient(circle at 2px 2px, #0ba6da 1px, transparent 0); background-size: 24px 24px;"></div>
<!-- Mock Graph Visualization -->
<div class="relative w-48 h-48">
<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-primary rounded-full shadow-lg shadow-primary/30 flex items-center justify-center text-white font-bold text-xs text-center p-1">核心热点</div>
<div class="absolute top-0 left-1/4 w-8 h-8 bg-slate-200 dark:bg-slate-700 rounded-full border-2 border-primary/40"></div>
<div class="absolute bottom-4 right-8 w-10 h-10 bg-slate-200 dark:bg-slate-700 rounded-full border-2 border-primary/40"></div>
<div class="absolute top-1/3 right-0 w-6 h-6 bg-slate-200 dark:bg-slate-700 rounded-full border-2 border-primary/40"></div>
<div class="absolute bottom-8 left-4 w-9 h-9 bg-slate-200 dark:bg-slate-700 rounded-full border-2 border-primary/40"></div>
<!-- Connection Lines -->
<svg class="absolute inset-0 w-full h-full text-primary/20" stroke="currentColor">
<line stroke-width="1" x1="50%" x2="30%" y1="50%" y2="10%"></line>
<line stroke-width="1" x1="50%" x2="80%" y1="50%" y2="80%"></line>
<line stroke-width="1" x1="50%" x2="90%" y1="50%" y2="35%"></line>
<line stroke-width="1" x1="50%" x2="15%" y1="50%" y2="70%"></line>
</svg>
</div>
</div>
<div class="mt-4 flex flex-wrap gap-2">
<span class="text-[10px] px-2 py-1 bg-slate-100 dark:bg-slate-700 rounded text-slate-500">机构主体 (12)</span>
<span class="text-[10px] px-2 py-1 bg-slate-100 dark:bg-slate-700 rounded text-slate-500">技术实体 (8)</span>
<span class="text-[10px] px-2 py-1 bg-slate-100 dark:bg-slate-700 rounded text-slate-500">地理位置 (5)</span>
</div>
</div>
</div>
<!-- Bottom Section - Insight -->
<div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 p-8">
<h3 class="text-lg font-bold flex items-center mb-6">
<span class="w-1.5 h-6 bg-primary rounded-full mr-3"></span>
                核心洞察摘要
            </h3>
<div class="flex flex-col md:flex-row gap-8">
<div class="flex-shrink-0 flex flex-wrap gap-3 w-full md:w-1/3 h-fit">
<span class="px-3 py-1.5 bg-primary/10 text-primary rounded-full text-xs font-bold border border-primary/20">生成式AI</span>
<span class="px-3 py-1.5 bg-amber-500/10 text-amber-600 rounded-full text-xs font-bold border border-amber-500/20">半导体工艺</span>
<span class="px-3 py-1.5 bg-emerald-500/10 text-emerald-600 rounded-full text-xs font-bold border border-emerald-500/20">碳中和技术</span>
<span class="px-3 py-1.5 bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 rounded-full text-xs font-bold">边缘计算</span>
<span class="px-3 py-1.5 bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 rounded-full text-xs font-bold">超导量子</span>
</div>
<div class="flex-grow">
<p class="text-slate-600 dark:text-slate-300 leading-relaxed text-sm mb-4">
                        当前技术监测显示，以“边缘端大模型部署”为核心的讨论声量在过去24小时内激增了180%。主要驱动因素来自于头部芯片厂商发布的最新移动平台算力指标。与此同时，能源科技领域的“高温超导”热点正从学术讨论转向产业化应用预期，关联企业股价波动明显。
                    </p>
<p class="text-slate-600 dark:text-slate-300 leading-relaxed text-sm">
                        综合建议：战略咨询团队应重点关注边缘AI生态链的重构可能，并启动针对量子计算容错路径的技术成熟度再评估。目前市场情感维持在稳健偏乐观区间，暂无大规模负面风险信号。
                    </p>
</div>
</div>
</div>
