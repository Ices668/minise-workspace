...
<button class="pb-4 border-b-2 border-primary text-primary font-bold text-base px-1">分析总览</button>
<button class="pb-4 border-b-2 border-transparent text-slate-500 dark:text-slate-400 font-medium text-base hover:text-slate-700 dark:hover:text-slate-200 px-1">二维交叉分析</button>
<button class="pb-4 border-b-2 border-transparent text-slate-500 dark:text-slate-400 font-medium text-base hover:text-slate-700 dark:hover:text-slate-200 px-1">任务列表</button>
</div>
</div>
<!-- Filters Section -->
<div class="flex flex-wrap gap-3 mb-8">
<button class="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full text-sm font-medium text-slate-700 dark:text-slate-200 hover:border-primary transition-all">
<span>发表年份</span>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700">
<p class="text-sm font-medium text-slate-500 dark:text-slate-400 mb-2">论文收录总数</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-black text-slate-900 dark:text-slate-50">12,482</span>
<span class="text-emerald-500 text-sm font-bold pb-1 flex items-center"><span class="material-symbols-outlined text-xs">trending_up</span> 12%</span>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700">
<p class="text-sm font-medium text-slate-500 dark:text-slate-400 mb-2">核心关键词数</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-black text-slate-900 dark:text-slate-50">856</span>
<span class="text-emerald-500 text-sm font-bold pb-1 flex items-center"><span class="material-symbols-outlined text-xs">trending_up</span> 5.4%</span>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700">
<p class="text-sm font-medium text-slate-500 dark:text-slate-400 mb-2">全球合作机构数</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-black text-slate-900 dark:text-slate-50">2,140</span>
<span class="text-amber-500 text-sm font-bold pb-1 flex items-center"><span class="material-symbols-outlined text-xs">trending_flat</span> 0.8%</span>
</div>
</div>
</div>
<!-- Row 2: Charts -->
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col">
<div class="flex justify-between items-center mb-6">
<h3 class="font-bold text-lg">关键词分析</h3>
<span class="text-xs text-primary font-bold cursor-pointer hover:underline">查看更多</span>
</div>
<div class="flex flex-col xl:flex-row gap-6 h-full min-h-[320px]">
<div class="flex-1 bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4 relative overflow-hidden flex flex-wrap content-center justify-center gap-3">
<!-- Simulated Word Cloud Tags -->
<span class="text-primary font-black text-3xl">人工智能</span>
<span class="text-slate-400 font-bold text-xl">大语言模型</span>
<span class="text-emerald-500 font-bold text-2xl">量子计算</span>
<span class="text-amber-500 font-medium text-lg">半导体</span>
<span class="text-rose-500 font-black text-4xl">深度学习</span>
<span class="text-indigo-400 font-medium text-md">神经网络</span>
<span class="text-primary/70 font-bold text-xl">自然语言处理</span>
<span class="text-slate-500 font-medium text-lg">算力优化</span>
<span class="text-emerald-400 font-bold text-2xl">可持续能源</span>
<span class="text-amber-600 font-medium text-sm">边际计算</span>
</div>
<div class="w-full xl:w-48">
<p class="text-xs font-bold text-slate-400 dark:text-slate-500 mb-3 uppercase tracking-wider">热度排行榜</p>
<ul class="space-y-3">
<li class="flex items-center justify-between">
<span class="flex items-center gap-2 text-sm"><span class="w-5 h-5 flex items-center justify-center bg-primary text-white text-[10px] rounded-full">1</span> 深度学习</span>
<span class="text-xs font-bold text-slate-400">2.4k</span>
</li>
<li class="flex items-center justify-between">
<span class="flex items-center gap-2 text-sm"><span class="w-5 h-5 flex items-center justify-center bg-primary/80 text-white text-[10px] rounded-full">2</span> 人工智能</span>
<span class="text-xs font-bold text-slate-400">1.9k</span>
</li>
<li class="flex items-center justify-between">
<span class="flex items-center gap-2 text-sm"><span class="w-5 h-5 flex items-center justify-center bg-primary/60 text-white text-[10px] rounded-full">3</span> 量子计算</span>
<span class="text-xs font-bold text-slate-400">1.5k</span>
</li>
<li class="flex items-center justify-between">
<span class="flex items-center gap-2 text-sm"><span class="w-5 h-5 flex items-center justify-center bg-slate-200 dark:bg-slate-700 text-slate-500 text-[10px] rounded-full">4</span> 核心算法</span>
<span class="text-xs font-bold text-slate-400">1.2k</span>
</li>
<li class="flex items-center justify-between">
<span class="flex items-center gap-2 text-sm"><span class="w-5 h-5 flex items-center justify-center bg-slate-200 dark:bg-slate-700 text-slate-500 text-[10px] rounded-full">5</span> 神经网络</span>
<span class="text-xs font-bold text-slate-400">0.9k</span>
</li>
</ul>
</div>
</div>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col">
<div class="flex justify-between items-center mb-6">
<h3 class="font-bold text-lg">全球论文分布图</h3>
<div class="flex items-center gap-2 bg-slate-100 dark:bg-slate-900 px-2 py-1 rounded text-[10px] font-bold text-slate-500">
<span class="w-2 h-2 rounded-full bg-primary/40"></span> 低
                        <span class="w-2 h-2 rounded-full bg-primary/80"></span> 中
                        <span class="w-2 h-2 rounded-full bg-primary"></span> 高
                    </div>
</div>
<div class="flex flex-col xl:flex-row gap-6 h-full min-h-[320px]">
<div class="flex-1 bg-slate-50 dark:bg-slate-900/50 rounded-lg relative overflow-hidden">
<img alt="World Map Distribution" class="w-full h-full object-cover opacity-60 mix-blend-multiply dark:mix-blend-overlay" data-alt="Stylized world map showing research paper density with blue bubbles" data-location="Global" src="assets/ff17bfed0051a954.bin"/>
<!-- Simulated Map Bubbles -->
<div class="absolute top-[30%] left-[20%] w-6 h-6 bg-primary/40 rounded-full animate-pulse border border-primary/20"></div>
<div class="absolute top-[35%] left-[75%] w-10 h-10 bg-primary/60 rounded-full animate-pulse border border-primary/20"></div>
<div class="absolute top-[45%] left-[82%] w-14 h-14 bg-primary rounded-full animate-pulse border border-primary/20"></div>
<div class="absolute top-[60%] left-[45%] w-8 h-8 bg-primary/30 rounded-full animate-pulse border border-primary/20"></div>
</div>
<div class="w-full xl:w-48">
<p class="text-xs font-bold text-slate-400 dark:text-slate-500 mb-3 uppercase tracking-wider">贡献度排行</p>
<div class="space-y-4">
<div>
...
<div class="w-full bg-slate-100 dark:bg-slate-700 h-1.5 rounded-full">
<div class="bg-primary/80 h-full rounded-full" style="width: 35%"></div>
</div>
</div>
<div>
<div class="flex justify-between text-xs mb-1 font-medium">
...
<div class="w-full bg-slate-100 dark:bg-slate-700 h-1.5 rounded-full">
<div class="bg-primary/60 h-full rounded-full" style="width: 18%"></div>
</div>
</div>
<div>
<div class="flex justify-between text-xs mb-1 font-medium">
...
<div class="w-full bg-slate-100 dark:bg-slate-700 h-1.5 rounded-full">
<div class="bg-primary/40 h-full rounded-full" style="width: 5%"></div>
</div>
</div>
</div>
</div>
...
<div class="lg:col-span-2 bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col">
<div class="flex justify-between items-center mb-6">
<h3 class="font-bold text-lg">作者合作关系网络</h3>
<div class="flex gap-2">
<button class="p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded transition-colors"><span class="material-symbols-outlined text-base">zoom_in</span></button>
<button class="p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded transition-colors"><span class="material-symbols-outlined text-base">zoom_out</span></button>
<button class="p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded transition-colors"><span class="material-symbols-outlined text-base">fullscreen</span></button>
</div>
</div>
<div class="flex-1 min-h-[400px] bg-slate-50 dark:bg-slate-900/50 rounded-lg relative overflow-hidden flex items-center justify-center">
...
<div class="relative w-full h-full flex flex-wrap items-center justify-center gap-20">
<div class="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-white font-bold text-xs text-center p-1 shadow-lg shadow-primary/30 z-10">张教授</div>
<div class="w-12 h-12 bg-white dark:bg-slate-800 border-2 border-primary/40 rounded-full flex items-center justify-center text-slate-700 dark:text-slate-300 font-bold text-[10px] shadow-md">李博士</div>
<div class="w-10 h-10 bg-white dark:bg-slate-800 border-2 border-primary/40 rounded-full flex items-center justify-center text-slate-700 dark:text-slate-300 font-bold text-[10px] shadow-md">Wang L.</div>
<div class="w-14 h-14 bg-white dark:bg-slate-800 border-2 border-primary/40 rounded-full flex items-center justify-center text-slate-700 dark:text-slate-300 font-bold text-[10px] shadow-md">Smith J.</div>
</div>
<div class="absolute bottom-4 right-4 text-[10px] bg-white/80 dark:bg-slate-800/80 px-2 py-1 rounded backdrop-blur-sm border border-slate-200 dark:border-slate-700">
                        * 线条粗细代表合作频次
                    </div>
</div>
</div>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col">
<div class="mb-6">
<h3 class="font-bold text-lg mb-4">核心作者列表</h3>
<div class="relative">
<span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm">search</span>
<input class="w-full bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 rounded-lg pl-9 py-2 text-sm focus:ring-primary focus:border-primary" placeholder="搜索作者或机构..." type="text"/>
</div>
</div>
<div class="flex-1 overflow-auto">
<table class="w-full text-left text-sm">
<thead class="sticky top-0 bg-white dark:bg-slate-800 z-10 border-b border-slate-100 dark:border-slate-700">
<tr>
<th class="pb-3 font-bold text-slate-400 text-xs">姓名/机构</th>
<th class="pb-3 font-bold text-slate-400 text-xs text-center">论文</th>
<th class="pb-3 font-bold text-slate-400 text-xs text-right">H-Index</th>
</tr>
</thead>
<tbody class="divide-y divide-slate-50 dark:divide-slate-700/50">
<tr>
<td class="py-4">
<p class="font-bold text-slate-900 dark:text-slate-50">张明远</p>
<p class="text-[10px] text-slate-400">清华大学人工智能实验室</p>
</td>
<td class="py-4 text-center font-bold text-primary">142</td>
<td class="py-4 text-right font-bold">58</td>
</tr>
<tr>
<td class="py-4">
<p class="font-bold text-slate-900 dark:text-slate-50">Sarah Jenkins</p>
<p class="text-[10px] text-slate-400">MIT Computer Science</p>
</td>
<td class="py-4 text-center font-bold text-primary">98</td>
<td class="py-4 text-right font-bold">42</td>
</tr>
<tr>
<td class="py-4">
<p class="font-bold text-slate-900 dark:text-slate-50">李伟强</p>
<p class="text-[10px] text-slate-400">中国科学院自动化所</p>
</td>
<td class="py-4 text-center font-bold text-primary">85</td>
<td class="py-4 text-right font-bold">39</td>
</tr>
<tr>
<td class="py-4">
<p class="font-bold text-slate-900 dark:text-slate-50">David Miller</p>
<p class="text-[10px] text-slate-400">Stanford University</p>
</td>
<td class="py-4 text-center font-bold text-primary">76</td>
<td class="py-4 text-right font-bold">45</td>
</tr>
<tr>
<td class="py-4">
<p class="font-bold text-slate-900 dark:text-slate-50">陈思佳</p>
<p class="text-[10px] text-slate-400">浙江大学计算机学院</p>
</td>
<td class="py-4 text-center font-bold text-primary">64</td>
<td class="py-4 text-right font-bold">31</td>
</tr>
</tbody>
</table>
</div>
<button class="mt-4 w-full py-2 text-xs font-bold text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-900 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
                    查看完整列表
                </button>
</div>
</div>
