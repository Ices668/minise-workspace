...
// Source: gkx-prototype/tech-alert.html
...
<a class="text-primary hover:opacity-80 text-sm font-medium" href="#">新型高端智库系统</a>
<span class="text-slate-400 dark:text-slate-500 text-sm">/</span>
<a class="text-primary hover:opacity-80 text-sm font-medium" href="#">战略咨询智能支持</a>
<span class="text-slate-400 dark:text-slate-500 text-sm">/</span>
<a class="text-primary hover:opacity-80 text-sm font-medium" href="#">技术趋势分析</a>
<span class="text-slate-400 dark:text-slate-500 text-sm">/</span>
<span class="text-slate-600 dark:text-slate-400 text-sm font-medium">技术动态预警</span>
</nav>
<!-- Header -->
<div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
<h1 class="text-3xl font-black tracking-tight text-slate-900 dark:text-slate-50">技术动态预警</h1>
<div class="flex items-center gap-3">
<button class="flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary hover:bg-primary/20 rounded-lg font-bold text-sm transition-colors">
...
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-2">今日新增预警</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-white">12</span>
<span class="text-emerald-500 text-sm font-medium mb-1">↑ 20%</span>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-2">待处理预警</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-white">28</span>
<span class="text-amber-500 text-sm font-medium mb-1">需关注</span>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-2">本月高危预警数</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-white">156</span>
<span class="text-rose-500 text-sm font-medium mb-1">↑ 8.4%</span>
</div>
</div>
</div>
<!-- Filter Section -->
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm mb-8">
<div class="grid grid-cols-1 md:grid-cols-4 gap-4">
<div class="relative">
<span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">search</span>
<input class="w-full pl-10 pr-4 py-2 bg-background-light dark:bg-slate-900 border-none rounded-full text-sm focus:ring-2 focus:ring-primary/50" placeholder="搜索技术名称..." type="text"/>
</div>
<select class="w-full px-4 py-2 bg-background-light dark:bg-slate-900 border-none rounded-full text-sm focus:ring-2 focus:ring-primary/50">
...
<select class="flex-1 px-4 py-2 bg-background-light dark:bg-slate-900 border-none rounded-full text-sm focus:ring-2 focus:ring-primary/50">
<option value="">处理状态</option>
<option>待处理</option>
<option>处理中</option>
<option>已完成</option>
</select>
<button class="px-6 py-2 bg-primary text-white font-bold rounded-full text-sm hover:opacity-90">查询</button>
<button class="px-6 py-2 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold rounded-full text-sm hover:opacity-90">重置</button>
</div>
</div>
</div>
<!-- Main Content Area -->
...
<h3 class="text-lg font-bold text-slate-900 dark:text-white">预警趋势分布图</h3>
<div class="flex items-center gap-4">
<span class="flex items-center gap-1 text-xs text-slate-500"><span class="w-3 h-3 rounded-full bg-rose-500"></span> 高危</span>
<span class="flex items-center gap-1 text-xs text-slate-500"><span class="w-3 h-3 rounded-full bg-amber-500"></span> 中等</span>
<span class="flex items-center gap-1 text-xs text-slate-500"><span class="w-3 h-3 rounded-full bg-blue-500"></span> 一般</span>
</div>
</div>
<div class="h-64 w-full bg-gradient-to-b from-primary/5 to-transparent rounded-lg relative overflow-hidden flex flex-col justify-end">
...
<div class="flex-1 bg-primary/30 rounded-t-sm h-[70%]"></div>
<div class="flex-1 bg-primary/50 rounded-t-sm h-[60%] border-t-2 border-primary"></div>
<div class="flex-1 bg-primary/60 rounded-t-sm h-[85%] border-t-2 border-primary"></div>
...
<!-- Legend X-axis -->
<div class="flex justify-between px-2 py-2 border-t border-slate-100 dark:border-slate-700 text-[10px] text-slate-400">
...
<h3 class="text-lg font-bold text-slate-900 dark:text-white">预警事件列表</h3>
</div>
<div class="overflow-x-auto">
<table class="w-full text-left border-collapse">
<thead>
<tr class="bg-slate-50 dark:bg-slate-900/50">
<th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">预警等级</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">时间</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">技术领域</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">预警内容摘要</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">预警类型</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">状态</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">操作</th>
</tr>
</thead>
...
<td class="px-6 py-4">
<span class="px-2 py-1 rounded bg-rose-100 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400 text-xs font-bold">高</span>
</td>
<td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">2023-10-24 14:20</td>
<td class="px-6 py-4 text-sm font-medium text-slate-900 dark:text-slate-200">量子计算</td>
<td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400 max-w-xs truncate">某实验室宣布实现1000位逻辑量子比特纠缠...</td>
<td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">突破性成果</td>
<td class="px-6 py-4">
<span class="flex items-center gap-1.5 text-xs font-medium text-amber-600">
<span class="w-1.5 h-1.5 rounded-full bg-amber-600"></span> 待处理
                                    </span>
</td>
<td class="px-6 py-4 text-sm">
<div class="flex gap-3 text-primary font-bold">
<button class="hover:underline">详情</button>
<button class="hover:underline">处理</button>
<button class="text-slate-400 hover:text-slate-600">忽略</button>
</div>
</td>
</tr>
<!-- Row 2 -->
<tr class="hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
<td class="px-6 py-4">
<span class="px-2 py-1 rounded bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 text-xs font-bold">中</span>
</td>
<td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">2023-10-24 10:05</td>
<td class="px-6 py-4 text-sm font-medium text-slate-900 dark:text-slate-200">固态电池</td>
<td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400 max-w-xs truncate">专利申请量环比增长300%，行业热度极速上升...</td>
<td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">增速异常</td>
<td class="px-6 py-4">
<span class="flex items-center gap-1.5 text-xs font-medium text-blue-600">
<span class="w-1.5 h-1.5 rounded-full bg-blue-600"></span> 处理中
                                    </span>
</td>
<td class="px-6 py-4 text-sm">
<div class="flex gap-3 text-primary font-bold">
...
<tr class="hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
<td class="px-6 py-4">
<span class="px-2 py-1 rounded bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-xs font-bold">低</span>
</td>
<td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">2023-10-23 16:45</td>
<td class="px-6 py-4 text-sm font-medium text-slate-900 dark:text-slate-200">生成式AI</td>
<td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400 max-w-xs truncate">开源模型社区活跃度异常，可能存在合规性风险...</td>
<td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">风险预警</td>
<td class="px-6 py-4">
<span class="flex items-center gap-1.5 text-xs font-medium text-slate-400">
<span class="w-1.5 h-1.5 rounded-full bg-slate-400"></span> 已完成
                                    </span>
</td>
<td class="px-6 py-4 text-sm">
<div class="flex gap-3 text-primary font-bold">
...
<button class="text-slate-400">已存档</button>
</div>
</td>
</tr>
</tbody>
...
<p class="text-xs text-slate-500">共 156 条记录，显示第 1-3 条</p>
<div class="flex gap-2">
<button class="p-1 rounded hover:bg-slate-100 dark:hover:bg-slate-700"><span class="material-symbols-outlined text-sm">chevron_left</span></button>
<button class="px-3 py-1 bg-primary text-white text-xs font-bold rounded">1</button>
<button class="px-3 py-1 hover:bg-slate-100 dark:hover:bg-slate-700 text-xs rounded">2</button>
<button class="px-3 py-1 hover:bg-slate-100 dark:hover:bg-slate-700 text-xs rounded">3</button>
<button class="p-1 rounded hover:bg-slate-100 dark:hover:bg-slate-700"><span class="material-symbols-outlined text-sm">chevron_right</span></button>
</div>
</div>
</div>
</div>
