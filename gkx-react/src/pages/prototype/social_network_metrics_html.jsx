...
// Source: gkx-prototype/social-network-metrics.html
...
<a class="text-primary hover:underline font-medium" href="#">分析工具</a>
<span class="text-slate-400">/</span>
<a class="text-primary hover:underline font-medium" href="#">社会网络分析</a>
<span class="text-slate-400">/</span>
<span class="text-slate-600 dark:text-slate-400 font-medium">分析结果</span>
</nav>
...
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium">节点总数</p>
<span class="material-symbols-outlined text-primary text-xl">hub</span>
</div>
<p class="text-2xl font-bold tracking-tight">1,284</p>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
<div class="flex items-center justify-between mb-2">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium">连线总数</p>
<span class="material-symbols-outlined text-primary text-xl">rebase_edit</span>
</div>
<p class="text-2xl font-bold tracking-tight">4,592</p>
<div class="mt-2 flex items-center gap-1 text-xs text-green-600">
<span class="material-symbols-outlined text-xs">trending_up</span>
<span>较上月 +8.4%</span>
</div>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
<div class="flex items-center justify-between mb-2">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium">网络密度</p>
<span class="material-symbols-outlined text-primary text-xl">grain</span>
</div>
<p class="text-2xl font-bold tracking-tight">0.028</p>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
<div class="flex items-center justify-between mb-2">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium">平均路径长度</p>
<span class="material-symbols-outlined text-primary text-xl">route</span>
</div>
<p class="text-2xl font-bold tracking-tight">3.45</p>
...
<button class="text-primary text-sm font-medium hover:bg-primary/5 px-2 py-1 rounded">查看全部</button>
</div>
<div class="overflow-x-auto">
<table class="w-full text-left text-sm">
<thead class="bg-slate-50 dark:bg-slate-900/50 text-slate-500">
<tr>
<th class="px-5 py-3 font-medium">节点名称</th>
<th class="px-5 py-3 font-medium">度中心性</th>
<th class="px-5 py-3 font-medium">介数中心性</th>
<th class="px-5 py-3 font-medium text-right">操作</th>
</tr>
</thead>
<tbody class="divide-y divide-slate-100 dark:divide-slate-700">
<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
<td class="px-5 py-4 font-medium">核心智库A</td>
<td class="px-5 py-4 text-primary font-semibold">0.85</td>
<td class="px-5 py-4 text-primary">0.42</td>
<td class="px-5 py-4 text-right">
<button class="text-primary hover:text-primary/80 font-bold">定位</button>
</td>
</tr>
<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
<td class="px-5 py-4 font-medium">研究机构B</td>
<td class="px-5 py-4 text-primary font-semibold">0.72</td>
<td class="px-5 py-4 text-primary">0.31</td>
<td class="px-5 py-4 text-right">
<button class="text-primary hover:text-primary/80 font-bold">定位</button>
</td>
</tr>
<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
<td class="px-5 py-4 font-medium">专家学者C</td>
<td class="px-5 py-4 text-primary font-semibold">0.68</td>
<td class="px-5 py-4 text-primary">0.28</td>
<td class="px-5 py-4 text-right">
<button class="text-primary hover:text-primary/80 font-bold">定位</button>
</td>
</tr>
...
<button class="text-primary text-sm font-medium hover:bg-primary/5 px-2 py-1 rounded">全局分析</button>
</div>
<div class="overflow-x-auto">
<table class="w-full text-left text-sm">
<thead class="bg-slate-50 dark:bg-slate-900/50 text-slate-500">
<tr>
<th class="px-5 py-3 font-medium">社区ID</th>
<th class="px-5 py-3 font-medium">成员数量</th>
<th class="px-5 py-3 font-medium">内聚性得分</th>
<th class="px-5 py-3 font-medium text-right">操作</th>
</tr>
</thead>
<tbody class="divide-y divide-slate-100 dark:divide-slate-700">
<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
<td class="px-5 py-4">
<span class="bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-bold">Cluster_01</span>
</td>
<td class="px-5 py-4 font-medium">45</td>
<td class="px-5 py-4 text-primary">0.88</td>
<td class="px-5 py-4 text-right">
<button class="bg-primary text-white text-xs px-3 py-1.5 rounded-lg hover:bg-primary/90 transition-colors">聚合查看</button>
</td>
</tr>
<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
<td class="px-5 py-4">
<span class="bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-bold">Cluster_02</span>
</td>
<td class="px-5 py-4 font-medium">32</td>
<td class="px-5 py-4 text-primary">0.75</td>
<td class="px-5 py-4 text-right">
<button class="bg-primary text-white text-xs px-3 py-1.5 rounded-lg hover:bg-primary/90 transition-colors">聚合查看</button>
</td>
</tr>
<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
<td class="px-5 py-4">
<span class="bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-bold">Cluster_03</span>
</td>
<td class="px-5 py-4 font-medium">28</td>
<td class="px-5 py-4 text-primary">0.62</td>
<td class="px-5 py-4 text-right">
<button class="bg-primary text-white text-xs px-3 py-1.5 rounded-lg hover:bg-primary/90 transition-colors">聚合查看</button>
</td>
</tr>
...
<div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
<div class="p-5 border-b border-slate-100 dark:border-slate-700 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
<h3 class="font-bold text-lg flex items-center gap-2">
...
<input class="pl-10 pr-4 py-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 rounded-lg text-sm focus:ring-primary focus:border-primary w-full sm:w-64" placeholder="搜索节点名称..." type="text"/>
</div>
<button class="flex items-center gap-1 bg-slate-100 dark:bg-slate-700 px-3 py-2 rounded-lg text-sm font-medium hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors">
...
<div class="overflow-x-auto">
<table class="w-full text-left text-sm">
<thead class="bg-slate-50 dark:bg-slate-900/50 text-slate-500 uppercase tracking-wider">
<tr>
<th class="px-6 py-4 font-semibold">节点名称</th>
<th class="px-6 py-4 font-semibold">标签</th>
<th class="px-6 py-4 font-semibold">关联数</th>
<th class="px-6 py-4 font-semibold">聚类类别</th>
<th class="px-6 py-4 font-semibold text-right">操作</th>
</tr>
</thead>
<tbody class="divide-y divide-slate-100 dark:divide-slate-700">
<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
<td class="px-6 py-4 font-medium">北京市智库办公室</td>
<td class="px-6 py-4">
<span class="bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-2 py-0.5 rounded text-xs">政府部门</span>
</td>
...
<button class="text-primary hover:text-primary/80 flex items-center gap-1">
<span class="material-symbols-outlined text-lg">edit_note</span> 编辑
                </button>
...
<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
<td class="px-6 py-4 font-medium">能源安全研究所</td>
<td class="px-6 py-4">
<span class="bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-2 py-0.5 rounded text-xs">科研机构</span>
</td>
...
<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
<td class="px-6 py-4 font-medium">李建国 教授</td>
<td class="px-6 py-4">
<span class="bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-2 py-0.5 rounded text-xs">专家个人</span>
</td>
...
<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
<td class="px-6 py-4 font-medium">全球化研究学会</td>
<td class="px-6 py-4">
<span class="bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-2 py-0.5 rounded text-xs">社会组织</span>
</td>
...
<div class="p-5 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between">
<p class="text-sm text-slate-500">显示第 1 至 4 条结果，共 1,284 条</p>
<div class="flex gap-2">
<button class="p-2 border border-slate-200 dark:border-slate-700 rounded hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-50" disabled="">
<span class="material-symbols-outlined text-lg">chevron_left</span>
</button>
<button class="px-3 py-1 bg-primary text-white rounded text-sm font-medium">1</button>
<button class="px-3 py-1 border border-slate-200 dark:border-slate-700 rounded text-sm hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">2</button>
<button class="px-3 py-1 border border-slate-200 dark:border-slate-700 rounded text-sm hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">3</button>
<span class="px-2 py-1">...</span>
<button class="px-3 py-1 border border-slate-200 dark:border-slate-700 rounded text-sm hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">129</button>
<button class="p-2 border border-slate-200 dark:border-slate-700 rounded hover:bg-slate-50 dark:hover:bg-slate-700">
