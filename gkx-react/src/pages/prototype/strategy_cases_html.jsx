...
// Source: gkx-prototype/strategy-cases.html
...
<a class="text-primary hover:opacity-80" href="#">战略咨询智能支持</a>
<span class="text-slate-400">/</span>
<a class="text-primary hover:opacity-80" href="#">战略咨询成果</a>
<span class="text-slate-400">/</span>
<span class="text-slate-600">战略咨询案例展示</span>
</nav>
<!-- Header -->
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
<h1 class="text-3xl font-black tracking-tight text-slate-900">战略咨询案例展示</h1>
<div class="flex items-center gap-3">
<button class="flex items-center gap-2 px-5 py-2.5 bg-primary text-white font-bold rounded-lg hover:bg-primary/90 transition-all shadow-sm">
<span class="material-symbols-outlined text-sm">add</span>
<span>新建案例</span>
</button>
<button class="flex items-center gap-2 px-5 py-2.5 bg-white border border-slate-200 text-slate-700 font-bold rounded-lg hover:bg-slate-50 transition-all shadow-sm">
<span class="material-symbols-outlined text-sm">ios_share</span>
<span>导出报表</span>
</button>
<button class="flex items-center justify-center p-2.5 bg-white border border-slate-200 text-slate-700 rounded-lg hover:bg-slate-50 transition-all shadow-sm">
<span class="material-symbols-outlined">refresh</span>
</button>
</div>
</div>
<!-- Filter Card -->
<div class="bg-white rounded-lg p-6 shadow-sm border border-slate-100 mb-8">
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
<div class="space-y-2 lg:col-span-1">
<label class="text-xs font-bold text-slate-500 uppercase tracking-wider">关键词检索</label>
<div class="relative flex items-center">
<span class="material-symbols-outlined absolute left-3 text-slate-400">search</span>
<input class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border-none rounded-full text-sm focus:ring-2 focus:ring-primary/20" placeholder="案例标题/关键词" type="text"/>
</div>
</div>
<div class="space-y-2">
<label class="text-xs font-bold text-slate-500 uppercase tracking-wider">成果类型</label>
<div class="relative">
<select class="w-full appearance-none pl-4 pr-10 py-2.5 bg-slate-50 border-none rounded-lg text-sm focus:ring-2 focus:ring-primary/20">
<option>全部类型</option>
<option>典型案例</option>
<option>决策建议</option>
<option>行业报告</option>
...
<div class="space-y-2">
<label class="text-xs font-bold text-slate-500 uppercase tracking-wider">所属领域</label>
<div class="relative">
<select class="w-full appearance-none pl-4 pr-10 py-2.5 bg-slate-50 border-none rounded-lg text-sm focus:ring-2 focus:ring-primary/20">
<option>全部领域</option>
<option>人工智能</option>
...
<button class="flex-1 py-2.5 bg-slate-100 text-slate-600 font-bold rounded-lg hover:bg-slate-200 transition-all">重置</button>
</div>
</div>
<div class="mt-4 flex items-center gap-4">
<label class="text-xs font-bold text-slate-500 uppercase tracking-wider">评价等级</label>
<div class="flex gap-2">
<button class="px-3 py-1 bg-primary/10 text-primary text-xs font-bold rounded-full">全部</button>
<button class="px-3 py-1 bg-slate-50 text-slate-600 text-xs font-medium rounded-full hover:bg-slate-100">5星</button>
<button class="px-3 py-1 bg-slate-50 text-slate-600 text-xs font-medium rounded-full hover:bg-slate-100">4星</button>
<button class="px-3 py-1 bg-slate-50 text-slate-600 text-xs font-medium rounded-full hover:bg-slate-100">3星及以下</button>
</div>
</div>
</div>
<!-- Toolbar -->
...
<button class="p-1.5 bg-white text-primary rounded shadow-sm">
<span class="material-symbols-outlined">grid_view</span>
</button>
<button class="p-1.5 text-slate-500 hover:text-slate-700">
...
<span class="text-sm font-bold">批量下载</span>
</button>
<div class="h-4 w-px bg-slate-300"></div>
<div class="flex items-center gap-2">
<span class="text-sm text-slate-500">排序方式:</span>
...
<!-- Card 1 -->
<div class="bg-white rounded-lg border border-slate-100 shadow-sm hover:shadow-md transition-all overflow-hidden group">
<div class="p-5">
<div class="flex justify-between items-start mb-4">
<div class="w-12 h-12 flex items-center justify-center bg-red-50 text-red-500 rounded-lg">
<span class="material-symbols-outlined text-3xl">description</span>
</div>
<span class="px-2 py-1 bg-primary/10 text-primary text-[10px] font-bold rounded-sm uppercase tracking-wide">典型案例</span>
</div>
<h3 class="text-lg font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">2024全球人工智能治理框架研究报告</h3>
<p class="text-sm text-slate-500 line-clamp-2 mb-4">本报告深入探讨了人工智能在全球范围内的监管现状与未来趋势，为智库决策提供核心战略支撑。</p>
<div class="flex flex-wrap gap-2 mb-6">
<span class="text-xs text-slate-400">#人工智能</span>
<span class="text-xs text-slate-400">#政策研究</span>
<span class="text-xs text-slate-400">#治理架构</span>
</div>
<div class="flex items-center justify-between py-3 border-y border-slate-50 text-xs text-slate-500">
...
<div class="flex items-center gap-3">
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">download</span> 1,280</span>
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">attachment</span> 12.5MB</span>
</div>
</div>
</div>
<div class="flex divide-x divide-slate-50 bg-slate-50/50">
<button class="flex-1 py-3 text-xs font-bold text-slate-600 hover:text-primary hover:bg-white transition-all flex items-center justify-center gap-1">
<span class="material-symbols-outlined text-sm">visibility</span> 在线查看
                    </button>
<button class="flex-1 py-3 text-xs font-bold text-slate-600 hover:text-primary hover:bg-white transition-all flex items-center justify-center gap-1">
<span class="material-symbols-outlined text-sm">download</span> 立即下载
                    </button>
<button class="flex-1 py-3 text-xs font-bold text-slate-600 hover:text-primary hover:bg-white transition-all flex items-center justify-center gap-1">
<span class="material-symbols-outlined text-sm">share</span> 生成分享
                    </button>
</div>
</div>
<!-- Card 2 -->
...
<div class="p-5">
<div class="flex justify-between items-start mb-4">
<div class="w-12 h-12 flex items-center justify-center bg-blue-50 text-blue-500 rounded-lg">
<span class="material-symbols-outlined text-3xl">article</span>
</div>
<span class="px-2 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-bold rounded-sm uppercase tracking-wide">决策建议</span>
</div>
<h3 class="text-lg font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">关于数字经济与实体经济融合发展的建议案</h3>
<p class="text-sm text-slate-500 line-clamp-2 mb-4">针对当前数实融合面临的瓶颈，提出一系列可落地的政策支持方向，助力区域经济高质量转型。</p>
<div class="flex flex-wrap gap-2 mb-6">
<span class="text-xs text-slate-400">#数字经济</span>
<span class="text-xs text-slate-400">#产业融合</span>
</div>
<div class="flex items-center justify-between py-3 border-y border-slate-50 text-xs text-slate-500">
<div class="flex items-center gap-1">
<span class="material-symbols-outlined text-yellow-400 text-sm" style="font-variation-settings: 'FILL' 1">star</span>
...
<div class="flex items-center gap-3">
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">download</span> 856</span>
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">attachment</span> 4.2MB</span>
</div>
</div>
</div>
<div class="flex divide-x divide-slate-50 bg-slate-50/50">
...
<div class="p-5">
<div class="flex justify-between items-start mb-4">
<div class="w-12 h-12 flex items-center justify-center bg-orange-50 text-orange-500 rounded-lg">
<span class="material-symbols-outlined text-3xl">analytics</span>
</div>
<span class="px-2 py-1 bg-amber-50 text-amber-600 text-[10px] font-bold rounded-sm uppercase tracking-wide">行业报告</span>
</div>
<h3 class="text-lg font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">2023年度能源领域碳中和战略执行评估</h3>
<p class="text-sm text-slate-500 line-clamp-2 mb-4">全面盘点国内重点能源企业在过去一年的碳减排成效，分析各细分领域的战略执行深度。</p>
<div class="flex flex-wrap gap-2 mb-6">
<span class="text-xs text-slate-400">#双碳</span>
<span class="text-xs text-slate-400">#能源转型</span>
</div>
<div class="flex items-center justify-between py-3 border-y border-slate-50 text-xs text-slate-500">
<div class="flex items-center gap-1">
<span class="material-symbols-outlined text-yellow-400 text-sm" style="font-variation-settings: 'FILL' 1">star</span>
...
<div class="flex items-center gap-3">
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">download</span> 2,104</span>
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">attachment</span> 28.1MB</span>
</div>
</div>
</div>
<div class="flex divide-x divide-slate-50 bg-slate-50/50">
...
<!-- Additional Cards to show grid layout -->
<!-- Card 4 -->
<div class="bg-white rounded-lg border border-slate-100 shadow-sm hover:shadow-md transition-all overflow-hidden group">
<div class="p-5">
<div class="flex justify-between items-start mb-4">
<div class="w-12 h-12 flex items-center justify-center bg-purple-50 text-purple-500 rounded-lg">
<span class="material-symbols-outlined text-3xl">description</span>
</div>
<span class="px-2 py-1 bg-primary/10 text-primary text-[10px] font-bold rounded-sm uppercase tracking-wide">典型案例</span>
</div>
<h3 class="text-lg font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">新型城镇化中的智慧城市集群建设路径</h3>
<p class="text-sm text-slate-500 line-clamp-2 mb-4">基于多地试点经验，总结出一套可复制的智慧城市集群治理模型与数据共享机制。</p>
<div class="flex flex-wrap gap-2 mb-6">
<span class="text-xs text-slate-400">#智慧城市</span>
<span class="text-xs text-slate-400">#城镇化</span>
</div>
<div class="flex items-center justify-between py-3 border-y border-slate-50 text-xs text-slate-500">
<div class="flex items-center gap-1">
<span class="material-symbols-outlined text-yellow-400 text-sm" style="font-variation-settings: 'FILL' 1">star</span>
<span class="font-bold text-slate-700">4.6</span>
</div>
<div class="flex items-center gap-3">
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">download</span> 642</span>
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">attachment</span> 15.7MB</span>
</div>
</div>
</div>
<div class="flex divide-x divide-slate-50 bg-slate-50/50">
...
<div class="p-5">
<div class="flex justify-between items-start mb-4">
<div class="w-12 h-12 flex items-center justify-center bg-emerald-50 text-emerald-500 rounded-lg">
<span class="material-symbols-outlined text-3xl">article</span>
</div>
<span class="px-2 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-bold rounded-sm uppercase tracking-wide">决策建议</span>
</div>
<h3 class="text-lg font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">全球产业链重构下的供应链安全预警方案</h3>
<p class="text-sm text-slate-500 line-clamp-2 mb-4">针对当前国际贸易环境变化，建立关键原材料与零部件的供应链风险监测体系建议。</p>
<div class="flex flex-wrap gap-2 mb-6">
<span class="text-xs text-slate-400">#国际贸易</span>
<span class="text-xs text-slate-400">#供应链</span>
</div>
<div class="flex items-center justify-between py-3 border-y border-slate-50 text-xs text-slate-500">
<div class="flex items-center gap-1">
<span class="material-symbols-outlined text-yellow-400 text-sm" style="font-variation-settings: 'FILL' 1">star</span>
...
<div class="flex items-center gap-3">
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">download</span> 3,450</span>
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">attachment</span> 8.9MB</span>
</div>
</div>
</div>
<div class="flex divide-x divide-slate-50 bg-slate-50/50">
...
<div class="p-5">
<div class="flex justify-between items-start mb-4">
<div class="w-12 h-12 flex items-center justify-center bg-cyan-50 text-cyan-500 rounded-lg">
<span class="material-symbols-outlined text-3xl">analytics</span>
</div>
<span class="px-2 py-1 bg-amber-50 text-amber-600 text-[10px] font-bold rounded-sm uppercase tracking-wide">行业报告</span>
</div>
<h3 class="text-lg font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">2024年量子计算商业化进程季度观察报告</h3>
<p class="text-sm text-slate-500 line-clamp-2 mb-4">追踪全球顶尖科技公司在量子算力商用化方面的最新突破，预测产业爆发的关键时间节点。</p>
<div class="flex flex-wrap gap-2 mb-6">
<span class="text-xs text-slate-400">#前沿技术</span>
<span class="text-xs text-slate-400">#量子计算</span>
</div>
<div class="flex items-center justify-between py-3 border-y border-slate-50 text-xs text-slate-500">
<div class="flex items-center gap-1">
<span class="material-symbols-outlined text-yellow-400 text-sm" style="font-variation-settings: 'FILL' 1">star</span>
...
<div class="flex items-center gap-3">
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">download</span> 438</span>
<span class="flex items-center gap-1"><span class="material-symbols-outlined text-sm">attachment</span> 5.4MB</span>
</div>
</div>
</div>
<div class="flex divide-x divide-slate-50 bg-slate-50/50">
...
<button class="flex items-center justify-center w-8 h-8 rounded border border-slate-200 text-slate-400 hover:border-primary hover:text-primary transition-all">
<span class="material-symbols-outlined text-sm">chevron_left</span>
</button>
<button class="flex items-center justify-center w-8 h-8 rounded bg-primary text-white text-xs font-bold">1</button>
<button class="flex items-center justify-center w-8 h-8 rounded border border-transparent text-slate-600 hover:bg-slate-100 text-xs font-bold">2</button>
<button class="flex items-center justify-center w-8 h-8 rounded border border-transparent text-slate-600 hover:bg-slate-100 text-xs font-bold">3</button>
<span class="text-slate-400 text-xs font-bold px-2">...</span>
<button class="flex items-center justify-center w-8 h-8 rounded border border-transparent text-slate-600 hover:bg-slate-100 text-xs font-bold">12</button>
<button class="flex items-center justify-center w-8 h-8 rounded border border-slate-200 text-slate-400 hover:border-primary hover:text-primary transition-all">
<span class="material-symbols-outlined text-sm">chevron_right</span>
</button>
<div class="flex items-center gap-2 ml-4">
<span class="text-xs text-slate-500">跳至</span>
<input class="w-10 h-8 border border-slate-200 rounded text-center text-xs focus:ring-1 focus:ring-primary focus:border-primary outline-none" type="text" value="1"/>
