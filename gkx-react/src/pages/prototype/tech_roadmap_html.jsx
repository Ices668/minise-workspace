...
// Source: gkx-prototype/tech-roadmap.html
...
<input class="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-slate-800 border-none rounded-lg text-sm focus:ring-2 focus:ring-primary/50" placeholder="搜索技术节点..." type="text"/>
</div>
</div>
<div class="flex-1 overflow-y-auto p-2 space-y-1">
<!-- Tree Groups -->
<div class="mb-4">
<div class="flex items-center gap-2 p-2 text-xs font-bold text-slate-400 uppercase tracking-wider">基础前沿</div>
<div class="space-y-1">
<div class="flex items-center gap-2 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg cursor-grab active:cursor-grabbing border border-transparent hover:border-slate-200 dark:hover:border-slate-700 group">
<span class="material-symbols-outlined text-primary text-lg">drag_indicator</span>
<span class="text-sm text-slate-700 dark:text-slate-300">量子芯片架构</span>
</div>
<div class="flex items-center gap-2 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg cursor-grab border border-transparent group">
<span class="material-symbols-outlined text-primary text-lg">drag_indicator</span>
<span class="text-sm text-slate-700 dark:text-slate-300">超导材料制备</span>
</div>
</div>
</div>
<div class="mb-4">
<div class="flex items-center gap-2 p-2 text-xs font-bold text-slate-400 uppercase tracking-wider">核心技术</div>
<div class="space-y-1">
<div class="flex items-center gap-2 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg cursor-grab border border-transparent">
<span class="material-symbols-outlined text-primary text-lg">drag_indicator</span>
<span class="text-sm text-slate-700 dark:text-slate-300">高密度封装工艺</span>
</div>
<div class="flex items-center gap-2 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg cursor-grab border border-transparent">
<span class="material-symbols-outlined text-primary text-lg">drag_indicator</span>
<span class="text-sm text-slate-700 dark:text-slate-300">三维异构集成</span>
</div>
<div class="flex items-center gap-2 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg cursor-grab border border-transparent">
<span class="material-symbols-outlined text-primary text-lg">drag_indicator</span>
<span class="text-sm text-slate-700 dark:text-slate-300">低功耗互连协议</span>
</div>
</div>
</div>
</div>
</aside>
<!-- Center: Roadmap Canvas -->
<section class="flex-1 overflow-auto bg-slate-50 dark:bg-background-dark p-8">
<div class="min-w-[1200px] bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden">
<!-- Matrix Grid -->
<table class="w-full border-collapse">
<thead>
<tr class="bg-slate-50 dark:bg-slate-800/50">
<th class="w-48 p-4 border-b border-r border-slate-200 dark:border-slate-800">
<div class="flex flex-col items-center justify-center text-xs text-slate-400 font-medium">
<span>研发阶段 \ 时间</span>
</div>
</th>
<th class="p-4 border-b border-r border-slate-200 dark:border-slate-800 text-sm font-bold">2025-2027</th>
<th class="p-4 border-b border-r border-slate-200 dark:border-slate-800 text-sm font-bold">2028-2030</th>
<th class="p-4 border-b border-slate-200 dark:border-slate-800 text-sm font-bold">2031-2035</th>
</tr>
</thead>
<tbody>
<!-- Row 1: 前沿探索 -->
<tr class="h-48">
<td class="p-4 border-b border-r border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/20 align-middle">
<div class="flex items-center gap-2 font-bold text-sm text-primary">
<span class="material-symbols-outlined">science</span>
                                        前沿探索
                                    </div>
</td>
<td class="p-4 border-b border-r border-slate-200 dark:border-slate-800 relative">
<div class="absolute inset-0 grid grid-cols-4 grid-rows-4 opacity-10 pointer-events-none">
<div class="border-b border-r border-slate-300"></div>
<div class="border-b border-r border-slate-300"></div>
</div>
<!-- Node Item -->
<div class="relative z-10 p-3 bg-white dark:bg-slate-800 border-2 border-primary rounded-lg shadow-sm w-44">
<div class="text-xs font-bold text-primary mb-1">节点 A-1</div>
<div class="text-sm font-medium">量子位逻辑验证</div>
<div class="mt-2 h-1 bg-slate-100 dark:bg-slate-700 rounded-full overflow-hidden">
<div class="bg-primary h-full w-2/3"></div>
</div>
</div>
</td>
<td class="p-4 border-b border-r border-slate-200 dark:border-slate-800"></td>
<td class="p-4 border-b border-slate-200 dark:border-slate-800"></td>
</tr>
<!-- Row 2: 技术突破 -->
<tr class="h-48">
<td class="p-4 border-b border-r border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/20 align-middle">
...
<td class="p-4 border-b border-r border-slate-200 dark:border-slate-800"></td>
<td class="p-4 border-b border-r border-slate-200 dark:border-slate-800 relative">
<div class="p-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-sm w-44 mb-4">
<div class="text-xs font-bold text-slate-400 mb-1">节点 B-2</div>
<div class="text-sm font-medium">100比特相干控制</div>
</div>
<!-- Line Simulation -->
<div class="absolute left-[-20px] top-1/2 w-10 h-px bg-primary/30"></div>
</td>
<td class="p-4 border-b border-slate-200 dark:border-slate-800"></td>
</tr>
<!-- Row 3: 产业化应用 -->
<tr class="h-48">
<td class="p-4 border-r border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/20 align-middle">
<div class="flex items-center gap-2 font-bold text-sm text-primary">
<span class="material-symbols-outlined">factory</span>
                                        产业化应用
                                    </div>
</td>
<td class="p-4 border-r border-slate-200 dark:border-slate-800"></td>
<td class="p-4 border-r border-slate-200 dark:border-slate-800"></td>
<td class="p-4 relative">
<div class="p-3 bg-primary text-white rounded-lg shadow-md w-44">
<div class="text-xs font-bold opacity-80 mb-1">节点 C-1</div>
<div class="text-sm font-bold">通用量子计算机原型</div>
...
<aside class="w-80 bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800 flex flex-col">
<div class="p-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
<h3 class="text-sm font-bold text-slate-900 dark:text-slate-100">节点详情配置</h3>
<div class="relative">
<select class="appearance-none bg-slate-100 dark:bg-slate-800 border-none text-[10px] font-bold rounded-full py-1 pl-3 pr-6 focus:ring-1 focus:ring-primary">
<option>当前版本 V1.4</option>
<option>历史版本 V1.3</option>
<option>基线版本 V1.0</option>
</select>
<span class="material-symbols-outlined absolute right-2 top-1/2 -translate-y-1/2 text-xs pointer-events-none">expand_more</span>
</div>
</div>
<div class="flex-1 overflow-y-auto p-5 space-y-6">
<div class="space-y-4">
<div>
<label class="block text-xs font-bold text-slate-400 uppercase mb-2">节点名称</label>
<input class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary transition-all" type="text" value="量子位逻辑验证"/>
</div>
<div>
<label class="block text-xs font-bold text-slate-400 uppercase mb-2">预计投入 (亿元)</label>
<div class="relative">
<input class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm px-3 py-2 focus:ring-2 focus:ring-primary" type="number" value="1.5"/>
<span class="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-slate-400">RMB</span>
</div>
</div>
<div>
<label class="block text-xs font-bold text-slate-400 uppercase mb-2">成熟度指标 (TRL)</label>
<div class="grid grid-cols-3 gap-2">
<button class="py-2 text-xs font-semibold rounded-lg bg-primary text-white border border-primary">TRL 1-3</button>
<button class="py-2 text-xs font-semibold rounded-lg bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700 hover:border-primary/50">TRL 4-6</button>
<button class="py-2 text-xs font-semibold rounded-lg bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700 hover:border-primary/50">TRL 7-9</button>
</div>
</div>
<div>
<label class="block text-xs font-bold text-slate-400 uppercase mb-2">依赖关系</label>
<div class="space-y-2">
<div class="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-100 dark:border-slate-700">
<span class="text-xs">量子纠错算法</span>
<button class="material-symbols-outlined text-sm text-slate-400 hover:text-red-500 transition-colors">close</button>
</div>
<button class="w-full py-2 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-lg text-xs text-slate-400 font-medium hover:border-primary hover:text-primary transition-all">
                                    + 添加前序依赖
                                </button>
</div>
</div>
...
<h4 class="text-xs font-bold text-slate-400 uppercase mb-4">版本记录</h4>
<div class="space-y-4">
<div class="relative pl-6 pb-4 border-l border-slate-200 dark:border-slate-800">
<div class="absolute left-[-5px] top-0 w-2.5 h-2.5 rounded-full bg-primary ring-4 ring-primary/20"></div>
<div class="text-xs font-bold">2023-11-20 14:30</div>
<div class="text-xs text-slate-500 mt-1">张专家 修改了研发预算</div>
</div>
<div class="relative pl-6">
<div class="absolute left-[-5px] top-0 w-2.5 h-2.5 rounded-full bg-slate-300 dark:bg-slate-700"></div>
<div class="text-xs font-bold text-slate-400">2023-11-18 09:15</div>
<div class="text-xs text-slate-500 mt-1">系统 自动同步战略库数据</div>
</div>
</div>
</div>
</div>
<div class="p-4 bg-slate-50 dark:bg-slate-800/50">
<button class="w-full py-2.5 bg-primary text-white rounded-xl text-sm font-bold shadow-sm hover:shadow-md transition-all active:scale-[0.98]">
                        应用配置
                    </button>
</div>
</aside>
