...
// Source: gkx-prototype/multi-source-data.html
...
<a class="text-slate-500 hover:text-primary transition-colors" href="#">新型高端智库系统</a>
<span class="text-slate-400">/</span>
<a class="text-slate-500 hover:text-primary transition-colors" href="#">战略咨询智能支持</a>
<span class="text-slate-400">/</span>
<a class="text-slate-500 hover:text-primary transition-colors" href="#">智能问数</a>
<span class="text-slate-400">/</span>
<span class="text-slate-900 font-semibold">多源数据接入</span>
</nav>
<!-- Page Header -->
<div class="flex flex-wrap items-center justify-between gap-4 mb-8">
<h1 class="text-3xl font-bold tracking-tight">多源数据接入</h1>
...
<button class="flex items-center gap-2 px-5 py-2.5 bg-primary text-white font-semibold rounded-lg hover:opacity-90 shadow-lg shadow-primary/20 transition-all">
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 flex items-center justify-between">
<div>
<p class="text-slate-500 text-sm mb-1">接入总数</p>
<h3 class="text-2xl font-bold">128 <span class="text-xs font-normal text-slate-400 ml-1">个数据源</span></h3>
</div>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 flex items-center justify-between">
<div>
<p class="text-slate-500 text-sm mb-1">今日实时同步</p>
<h3 class="text-2xl font-bold">45,210 <span class="text-xs font-normal text-slate-400 ml-1">条记录</span></h3>
</div>
<div class="w-12 h-12 bg-emerald-50 rounded-full flex items-center justify-center text-emerald-500">
<span class="material-symbols-outlined text-emerald-500">sync</span>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 flex items-center justify-between">
<div>
<p class="text-slate-500 text-sm mb-1">数据清洗异常</p>
<h3 class="text-2xl font-bold text-rose-500">12 <span class="text-xs font-normal text-slate-400 ml-1">项待处理</span></h3>
</div>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 flex items-center justify-between">
<div>
<p class="text-slate-500 text-sm mb-1">接入健康度</p>
<h3 class="text-2xl font-bold">98.5<span class="text-sm font-normal ml-1">%</span></h3>
</div>
...
<circle class="text-primary" cx="24" cy="24" fill="transparent" r="20" stroke="currentColor" stroke-dasharray="125.6" stroke-dashoffset="1.8" stroke-width="4"></circle>
</svg>
<span class="absolute inset-0 flex items-center justify-center text-[10px] font-bold">OK</span>
</div>
</div>
</div>
<!-- Filter Card -->
<div class="bg-white dark:bg-slate-800 p-5 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 mb-8">
<div class="flex flex-wrap items-center gap-4">
<div class="flex-1 min-w-[280px]">
<div class="relative">
<span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[20px]">search</span>
<input class="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-slate-900 border-none rounded-full text-sm focus:ring-2 focus:ring-primary/30" placeholder="搜索数据源名称、ID或关键词..." type="text"/>
</div>
</div>
<div class="flex flex-wrap items-center gap-3">
<div class="relative group">
<button class="flex items-center gap-2 px-4 py-2 bg-slate-50 dark:bg-slate-900 rounded-full text-sm font-medium hover:bg-slate-100 transition-colors">
<span>接入类型</span>
...
<button class="px-4 py-2 text-primary font-medium text-sm hover:underline">重置条件</button>
</div>
</div>
</div>
<!-- Main Content - List & Monitoring View -->
<div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden">
<!-- Toolbar -->
<div class="p-4 border-b border-slate-100 dark:border-slate-700 flex items-center justify-between bg-slate-50/50 dark:bg-slate-900/50">
<div class="flex items-center p-1 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
<button class="p-1.5 rounded-md bg-primary text-white shadow-sm flex items-center justify-center">
<span class="material-symbols-outlined text-[20px]">list</span>
</button>
<button class="p-1.5 rounded-md text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 flex items-center justify-center">
<span class="material-symbols-outlined text-[20px]">grid_view</span>
</button>
</div>
<div class="flex items-center gap-3">
<button class="px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition-colors flex items-center gap-2">
...
<button class="px-4 py-2 text-sm font-medium text-primary hover:bg-primary/5 rounded-lg transition-colors flex items-center gap-2">
...
<thead>
<tr class="text-slate-500 text-sm uppercase tracking-wider font-semibold border-b border-slate-100 dark:border-slate-700">
<th class="px-6 py-4 w-12">
<input class="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox"/>
</th>
<th class="px-6 py-4">数据源名称</th>
<th class="px-6 py-4">接入方式</th>
<th class="px-6 py-4">实时状态</th>
<th class="px-6 py-4 text-center">同步频率</th>
<th class="px-6 py-4 text-right">数据量</th>
<th class="px-6 py-4 text-center">质量评分</th>
...
<span class="font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors cursor-pointer">全球宏观经济指标库</span>
<span class="text-xs text-slate-400">ID: SRC-882190</span>
</div>
</td>
<td class="px-6 py-5">
<div class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-[20px] text-indigo-500">api</span>
<span>REST API</span>
</div>
</td>
<td class="px-6 py-5">
...
<span class="text-emerald-600 font-medium">同步成功</span>
</div>
</td>
<td class="px-6 py-5 text-center text-sm">每10分钟</td>
<td class="px-6 py-5 text-right font-mono text-sm">1.2 TB</td>
<td class="px-6 py-5 text-center">
<span class="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-xs font-bold rounded">98.2</span>
</td>
<td class="px-6 py-5 text-sm text-slate-500">2023-11-24 14:21:05</td>
<td class="px-6 py-5 text-right">
<div class="flex items-center justify-end gap-3 text-primary text-sm font-medium">
<button class="hover:underline">详情</button>
<button class="hover:underline">配置</button>
<button class="hover:underline text-rose-500">删除</button>
</div>
</td>
</tr>
<!-- Table Row 2 -->
...
<td class="px-6 py-5">
<div class="flex flex-col">
<span class="font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors cursor-pointer">区域能源安全监测数据</span>
<span class="text-xs text-slate-400">ID: SRC-441021</span>
</div>
</td>
<td class="px-6 py-5">
<div class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-[20px] text-amber-500">storage</span>
...
<span class="text-primary font-medium">同步中...</span>
</div>
</td>
<td class="px-6 py-5 text-center text-sm">每1小时</td>
<td class="px-6 py-5 text-right font-mono text-sm">450.5 GB</td>
<td class="px-6 py-5 text-center">
<span class="px-2 py-0.5 bg-amber-50 text-amber-600 text-xs font-bold rounded">85.0</span>
</td>
<td class="px-6 py-5 text-sm text-slate-500">2023-11-24 14:15:33</td>
<td class="px-6 py-5 text-right">
<div class="flex items-center justify-end gap-3 text-primary text-sm font-medium">
<button class="hover:underline">详情</button>
<button class="hover:underline">配置</button>
...
<td class="px-6 py-5">
<div class="flex flex-col">
<span class="font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors cursor-pointer">行业政策研报(PDF)</span>
<span class="text-xs text-slate-400">ID: SRC-301294</span>
</div>
</td>
<td class="px-6 py-5">
<div class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-[20px] text-rose-400">description</span>
...
<span class="text-rose-600 font-medium">同步异常</span>
</div>
</td>
<td class="px-6 py-5 text-center text-sm">每日</td>
<td class="px-6 py-5 text-right font-mono text-sm">82.1 GB</td>
<td class="px-6 py-5 text-center">
<span class="px-2 py-0.5 bg-slate-100 text-slate-500 text-xs font-bold rounded">--</span>
</td>
<td class="px-6 py-5 text-sm text-slate-500">2023-11-23 09:00:01</td>
<td class="px-6 py-5 text-right">
<div class="flex items-center justify-end gap-3 text-primary text-sm font-medium">
<button class="hover:underline">详情</button>
<button class="hover:underline">配置</button>
...
<td class="px-6 py-5">
<div class="flex flex-col">
<span class="font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors cursor-pointer">重点智库合作专家库</span>
<span class="text-xs text-slate-400">ID: SRC-102298</span>
</div>
</td>
<td class="px-6 py-5">
<div class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-[20px] text-cyan-500">cloud</span>
...
<span class="text-slate-500 font-medium">已暂停</span>
</div>
</td>
<td class="px-6 py-5 text-center text-sm">手动触发</td>
<td class="px-6 py-5 text-right font-mono text-sm">4.5 GB</td>
<td class="px-6 py-5 text-center">
<span class="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-xs font-bold rounded">95.1</span>
</td>
<td class="px-6 py-5 text-sm text-slate-500">2023-11-20 18:33:41</td>
<td class="px-6 py-5 text-right">
<div class="flex items-center justify-end gap-3 text-primary text-sm font-medium">
<button class="hover:underline">详情</button>
<button class="hover:underline">配置</button>
...
<!-- Pagination -->
<div class="px-6 py-4 flex items-center justify-between bg-slate-50/50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-700">
<span class="text-sm text-slate-500">显示 1 到 4 共 128 条记录</span>
...
<button class="w-8 h-8 rounded-lg bg-primary text-white font-bold text-sm">1</button>
<button class="w-8 h-8 rounded-lg hover:bg-white dark:hover:bg-slate-800 transition-colors text-sm">2</button>
<button class="w-8 h-8 rounded-lg hover:bg-white dark:hover:bg-slate-800 transition-colors text-sm">3</button>
<span class="text-slate-400">...</span>
<button class="w-8 h-8 rounded-lg hover:bg-white dark:hover:bg-slate-800 transition-colors text-sm">32</button>
<button class="p-2 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-white dark:hover:bg-slate-800 transition-colors">
