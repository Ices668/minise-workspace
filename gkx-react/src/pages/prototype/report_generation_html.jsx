...
// Source: gkx-prototype/report-generation.html
...
<span class="text-slate-400 text-sm">/</span>
<span class="text-slate-600 dark:text-slate-400 text-sm font-medium">战略咨询报告生成</span>
</nav>
<!-- Header -->
<header class="flex flex-wrap items-center justify-between gap-4 mb-8">
<h1 class="text-3xl font-black tracking-tight text-slate-900 dark:text-white">战略咨询报告生成</h1>
<div class="flex items-center gap-3">
<button class="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-bold text-sm transition-all hover:bg-slate-50">
<span class="material-symbols-outlined text-[20px]">save</span>
                    保存草稿
                </button>
<button class="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary/10 text-primary border border-primary/20 font-bold text-sm transition-all hover:bg-primary/20">
<span class="material-symbols-outlined text-[20px]">picture_as_pdf</span>
                    导出PDF
                </button>
<button class="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-white font-bold text-sm shadow-lg shadow-primary/20 transition-all hover:opacity-90">
...
<h2 class="text-lg font-bold">AI 生成配置</h2>
</div>
<div class="space-y-5">
<div class="flex flex-col gap-2">
<label class="text-sm font-semibold text-slate-700 dark:text-slate-300">报告主题</label>
<input class="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-sm focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all" placeholder="请输入报告主题，例如：2024全球低空经济发展态势" type="text"/>
</div>
<div class="flex flex-col gap-2">
<label class="text-sm font-semibold text-slate-700 dark:text-slate-300">报告类型</label>
<select class="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-sm focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none appearance-none">
...
<div class="flex flex-col gap-2">
<label class="text-sm font-semibold text-slate-700 dark:text-slate-300">关联技术领域</label>
<div class="flex flex-wrap gap-2 p-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
<span class="bg-primary/10 text-primary text-xs font-bold px-2 py-1 rounded flex items-center gap-1">
                                    无人驾驶机 <span class="material-symbols-outlined text-[14px] cursor-pointer">close</span>
</span>
<span class="bg-primary/10 text-primary text-xs font-bold px-2 py-1 rounded flex items-center gap-1">
                                    5G/6G通讯 <span class="material-symbols-outlined text-[14px] cursor-pointer">close</span>
</span>
<button class="text-slate-400 text-xs font-medium px-2 py-1 border border-dashed border-slate-300 rounded hover:border-primary hover:text-primary">+ 添加领域</button>
</div>
</div>
<div class="flex flex-col gap-2">
<label class="text-sm font-semibold text-slate-700 dark:text-slate-300">数据时间范围</label>
<div class="relative">
<input class="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-sm outline-none" type="text" value="2023-01-01 至 2024-05-30"/>
<span class="material-symbols-outlined absolute right-3 top-3 text-slate-400">calendar_month</span>
</div>
</div>
<div class="flex flex-col gap-2">
<label class="text-sm font-semibold text-slate-700 dark:text-slate-300 flex justify-between">
                                核心大纲 (AI 自动生成)
                                <button class="text-primary text-xs hover:underline">重新生成大纲</button>
</label>
<div class="bg-slate-50 dark:bg-slate-900 rounded-lg p-4 text-sm text-slate-600 dark:text-slate-400 space-y-3 max-h-60 overflow-y-auto custom-scrollbar">
...
<button class="w-full mt-4 py-4 rounded-xl bg-primary text-white font-bold flex items-center justify-center gap-3 shadow-lg shadow-primary/30 hover:scale-[1.02] transition-transform">
...
<!-- Right Panel: Preview & Edit (2/3) -->
<section class="col-span-12 lg:col-span-8">
<div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col h-full min-h-[800px]">
<!-- Toolbar -->
<div class="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-slate-700">
<div class="flex items-center gap-4">
<h3 class="font-bold text-slate-800 dark:text-slate-100">报告实时预览</h3>
<div class="flex items-center bg-slate-100 dark:bg-slate-900 rounded-lg p-1">
<button class="p-1 hover:bg-white dark:hover:bg-slate-800 rounded shadow-sm text-slate-500">
<span class="material-symbols-outlined text-[18px]">remove</span>
</button>
<span class="px-3 text-xs font-bold text-slate-600 dark:text-slate-400">100%</span>
<button class="p-1 hover:bg-white dark:hover:bg-slate-800 rounded shadow-sm text-slate-500">
...
<div class="flex items-center gap-3">
<span class="text-sm text-slate-500">手动编辑模式</span>
...
<!-- Report Content Area (Paper Style) -->
<div class="flex-1 bg-slate-50 dark:bg-slate-900/50 p-10 overflow-y-auto custom-scrollbar">
<article class="max-w-[800px] mx-auto bg-white dark:bg-slate-800 shadow-xl min-h-[1000px] p-16 rounded-sm border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200">
<!-- Report Title Section -->
<div class="text-center mb-12 border-b-2 border-primary/20 pb-8">
<h2 class="text-3xl font-black mb-4">2024年全球低空经济发展战略研究报告</h2>
<p class="text-slate-500 font-medium">新型高端智库战略咨询组 · 2024年5月</p>
</div>
<!-- Executive Summary -->
<section class="mb-10">
...
<div class="bg-primary/5 p-5 rounded-lg border-l-4 border-primary italic text-slate-600 dark:text-slate-300 leading-relaxed">
...
<!-- Chart Placeholder 1 -->
<div class="my-8 bg-slate-50 dark:bg-slate-900 rounded-xl p-6 border border-slate-100 dark:border-slate-700">
<div class="flex justify-between items-center mb-4">
<h4 class="text-sm font-bold text-slate-700 dark:text-slate-300 italic">图1：2020-2024全球低空经济市场规模增长趋势 (亿美元)</h4>
<span class="text-xs bg-primary/10 text-primary px-2 py-1 rounded">AI 生成图表</span>
</div>
<div class="h-48 w-full flex items-end justify-around gap-4 px-4 pt-4 border-b border-slate-200">
<div class="bg-primary/40 w-12 h-1/4 rounded-t-sm hover:bg-primary transition-colors relative group">
<span class="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-bold hidden group-hover:block">120</span>
</div>
<div class="bg-primary/50 w-12 h-2/5 rounded-t-sm hover:bg-primary transition-colors relative group">
<span class="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-bold hidden group-hover:block">185</span>
</div>
<div class="bg-primary/60 w-12 h-3/5 rounded-t-sm hover:bg-primary transition-colors relative group">
<span class="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-bold hidden group-hover:block">290</span>
</div>
<div class="bg-primary/80 w-12 h-4/5 rounded-t-sm hover:bg-primary transition-colors relative group">
<span class="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-bold hidden group-hover:block">410</span>
</div>
<div class="bg-primary w-12 h-full rounded-t-sm hover:bg-primary transition-colors relative group">
<span class="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-bold hidden group-hover:block">550</span>
</div>
</div>
<div class="flex justify-around mt-2 text-[10px] text-slate-400 font-bold uppercase">
<span>2020</span>
<span>2021</span>
<span>2022</span>
<span>2023</span>
...
<div class="w-48 h-48 bg-slate-100 dark:bg-slate-900 rounded-full flex items-center justify-center relative border-4 border-primary/10">
<div class="absolute inset-0 flex items-center justify-center">
<div class="w-32 h-32 rounded-full border-[16px] border-primary border-t-transparent border-r-primary/40 -rotate-45"></div>
</div>
<div class="text-center z-10">
<p class="text-[10px] font-bold text-slate-400">技术构成</p>
<p class="text-sm font-black text-primary">专利占比</p>
</div>
</div>
</div>
</section>
<!-- AI Placeholder for more content -->
<div class="mt-12 py-10 border-t border-dashed border-slate-200 dark:border-slate-700 text-center">
<span class="material-symbols-outlined text-primary/40 text-4xl mb-4 animate-pulse">more_horiz</span>
<p class="text-slate-400 text-sm italic">AI 正在继续生成后续章节内容...</p>
</div>
</article>
</div>
</div>
