...
// Source: gkx-prototype/common-network-task.html
...
<span class="text-slate-400 text-sm">/</span>
<a class="text-primary/80 hover:text-primary text-sm font-medium" href="#">技术趋势分析</a>
<span class="text-slate-400 text-sm">/</span>
<span class="text-slate-900 dark:text-slate-100 text-sm font-semibold">共性网络分析</span>
</nav>
<!-- Page Header -->
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
<h1 class="text-3xl font-black tracking-tight text-slate-900 dark:text-slate-100">共性网络分析</h1>
<div class="flex flex-wrap items-center gap-3">
<button class="flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-lg font-bold text-sm hover:bg-primary/90 transition-colors shadow-sm">
<span class="material-symbols-outlined text-lg">add_circle</span>
<span>创建网络分析</span>
</button>
<button class="flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 rounded-lg font-bold text-sm hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm">
<span class="material-symbols-outlined text-lg">grid_on</span>
<span>导出矩阵</span>
</button>
<button class="flex items-center justify-center w-10 h-10 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm">
...
<a class="relative pb-4 text-sm font-bold text-primary border-b-2 border-primary" href="#">
                    分析任务
                </a>
<a class="relative pb-4 text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-primary transition-colors" href="#">
                    语义图谱
                </a>
<a class="relative pb-4 text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-primary transition-colors" href="#">
                    关系矩阵
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col gap-2">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium">运行中任务</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-slate-100">12</span>
<span class="text-emerald-500 text-sm font-bold mb-1">+2%</span>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col gap-2">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium">累计生成图谱</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-slate-100">1,280</span>
<span class="text-emerald-500 text-sm font-bold mb-1">+14</span>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col gap-2">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium">语义关系对</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-slate-100">45.2k</span>
<span class="text-slate-400 text-sm font-medium mb-1">活跃</span>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col gap-2">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium">核心聚类数</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-slate-100">86</span>
<span class="text-amber-500 text-sm font-bold mb-1">需关注</span>
</div>
</div>
</div>
...
<!-- Task Card 1 -->
<div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col overflow-hidden hover:border-primary/50 transition-colors">
<div class="p-6 flex-1">
<div class="flex justify-between items-start mb-4">
<h3 class="font-bold text-lg text-slate-900 dark:text-slate-100">量子计算全球专利共性分析</h3>
<span class="px-2 py-1 bg-primary/10 text-primary text-xs font-bold rounded">分析中</span>
</div>
<div class="space-y-3 mb-6">
<div class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-slate-400 text-base">database</span>
<span class="text-slate-500 dark:text-slate-400">数据源:</span>
<span class="text-slate-700 dark:text-slate-200 font-medium">WIPO 全球专利库</span>
</div>
<div class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-slate-400 text-base">settings_input_component</span>
<span class="text-slate-500 dark:text-slate-400">算法类型:</span>
<span class="text-slate-700 dark:text-slate-200 font-medium">BERT Semantic Analysis</span>
</div>
</div>
<div class="space-y-2">
<div class="flex justify-between text-xs font-bold">
<span class="text-slate-500">计算进度</span>
...
<button class="flex-1 py-2 bg-primary/10 text-primary text-sm font-bold rounded-lg hover:bg-primary/20 transition-colors">查看图谱</button>
<button class="flex-1 py-2 bg-transparent text-slate-500 dark:text-slate-400 text-sm font-bold rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">详情</button>
</div>
</div>
<!-- Task Card 2 -->
<div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col overflow-hidden hover:border-primary/50 transition-colors">
<div class="p-6 flex-1">
<div class="flex justify-between items-start mb-4">
<h3 class="font-bold text-lg text-slate-900 dark:text-slate-100">半导体材料前沿论文学术网络</h3>
<span class="px-2 py-1 bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 text-xs font-bold rounded">已完成</span>
</div>
<div class="space-y-3 mb-6">
<div class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-slate-400 text-base">database</span>
<span class="text-slate-500 dark:text-slate-400">数据源:</span>
<span class="text-slate-700 dark:text-slate-200 font-medium">IEEE &amp; Elsevier Papers</span>
</div>
<div class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-slate-400 text-base">settings_input_component</span>
<span class="text-slate-500 dark:text-slate-400">算法类型:</span>
<span class="text-slate-700 dark:text-slate-200 font-medium">Louvain Clustering</span>
</div>
</div>
<div class="space-y-2">
<div class="flex justify-between text-xs font-bold">
...
<div class="px-6 py-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700 flex gap-3">
<button class="flex-1 py-2 bg-primary text-white text-sm font-bold rounded-lg hover:bg-primary/90 transition-colors shadow-sm">查看图谱</button>
<button class="flex-1 py-2 bg-transparent text-slate-500 dark:text-slate-400 text-sm font-bold rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">详情</button>
</div>
</div>
<!-- Task Card 3 -->
...
<div class="p-6 flex-1">
<div class="flex justify-between items-start mb-4">
<h3 class="font-bold text-lg text-slate-900 dark:text-slate-100">新型储能技术演进路径识别</h3>
<span class="px-2 py-1 bg-amber-100 text-amber-700 text-xs font-bold rounded">排队中</span>
</div>
<div class="space-y-3 mb-6">
<div class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-slate-400 text-base">database</span>
<span class="text-slate-500 dark:text-slate-400">数据源:</span>
<span class="text-slate-700 dark:text-slate-200 font-medium">Multi-source Journals</span>
</div>
<div class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-slate-400 text-base">settings_input_component</span>
<span class="text-slate-500 dark:text-slate-400">算法类型:</span>
<span class="text-slate-700 dark:text-slate-200 font-medium">TextRank &amp; Co-occurrence</span>
</div>
</div>
<div class="space-y-2">
<div class="flex justify-between text-xs font-bold">
<span class="text-slate-500">等待任务数</span>
<span class="text-amber-600">3个任务前置</span>
</div>
<div class="w-full bg-slate-100 dark:bg-slate-700 h-2 rounded-full overflow-hidden">
...
<div class="px-6 py-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700 flex gap-3">
<button class="flex-1 py-2 bg-slate-100 dark:bg-slate-700 text-slate-400 text-sm font-bold rounded-lg cursor-not-allowed">查看图谱</button>
<button class="flex-1 py-2 bg-transparent text-slate-500 dark:text-slate-400 text-sm font-bold rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">详情</button>
</div>
</div>
</div>
<!-- Conceptual Visualization Section (Preview) -->
<div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden h-[500px] flex">
<!-- Left Control Panel -->
<div class="w-72 border-r border-slate-200 dark:border-slate-700 p-6 flex flex-col gap-6">
<div>
...
<div class="space-y-6">
<div class="space-y-3">
<label class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">节点密度</label>
<input class="w-full h-1.5 bg-slate-200 dark:bg-slate-700 rounded-lg appearance-none cursor-pointer accent-primary" type="range"/>
...
<div class="space-y-3">
<label class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">关联强度阈值</label>
<input class="w-full h-1.5 bg-slate-200 dark:bg-slate-700 rounded-lg appearance-none cursor-pointer accent-primary" type="range" value="65"/>
<div class="flex justify-between text-[10px] text-slate-400">
<span>0.1</span>
<span>1.0</span>
</div>
...
<label class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3 block">节点类型显示</label>
<div class="space-y-2">
<label class="flex items-center gap-2 cursor-pointer">
<input checked="" class="rounded text-primary focus:ring-primary w-4 h-4" type="checkbox"/>
<span class="text-sm text-slate-700 dark:text-slate-200">核心技术术语</span>
</label>
<label class="flex items-center gap-2 cursor-pointer">
<input checked="" class="rounded text-primary focus:ring-primary w-4 h-4" type="checkbox"/>
<span class="text-sm text-slate-700 dark:text-slate-200">机构/组织</span>
</label>
<label class="flex items-center gap-2 cursor-pointer">
<input class="rounded text-primary focus:ring-primary w-4 h-4" type="checkbox"/>
<span class="text-sm text-slate-700 dark:text-slate-200">应用场景</span>
</label>
</div>
</div>
</div>
...
<div class="mt-auto">
<button class="w-full py-2.5 bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 text-sm font-bold rounded-lg hover:opacity-90 transition-opacity">
                            重置布局
                        </button>
</div>
</div>
<!-- Visualization Area (Placeholder) -->
<div class="flex-1 relative bg-slate-50 dark:bg-slate-900/50 flex items-center justify-center overflow-hidden">
<!-- Abstract Background Pattern for Network Graph -->
<div class="absolute inset-0 opacity-20" data-alt="Abstract network pattern background" style="background-image: radial-gradient(#0ba6da 1px, transparent 1px); background-size: 32px 32px;">
</div>
...
<span class="material-symbols-outlined text-4xl text-primary animate-pulse">hub</span>
</div>
<h4 class="text-slate-900 dark:text-slate-100 font-bold text-lg">语义网络可视化加载中...</h4>
<p class="text-slate-500 text-sm mt-1 max-w-xs px-4">正在基于 45,200 个语义关系对构建实时动态拓扑图</p>
</div>
<!-- Floating Tools -->
<div class="absolute bottom-6 right-6 flex flex-col gap-2">
<button class="w-10 h-10 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg flex items-center justify-center text-slate-600 dark:text-slate-300 shadow-lg hover:text-primary transition-colors">
