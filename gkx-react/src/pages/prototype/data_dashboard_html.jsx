...
// Source: gkx-prototype/data-dashboard.html
...
<link href="assets/322b47f8fe20a4bb.bin" rel="stylesheet"/>
...
<nav class="flex items-center gap-2 mb-4 text-xs font-medium">
<a class="text-slate-500 hover:text-primary" href="#">新型高端智库系统</a>
<span class="text-slate-300">/</span>
<a class="text-slate-500 hover:text-primary" href="#">战略咨询智能支持</a>
<span class="text-slate-300">/</span>
<a class="text-slate-500 hover:text-primary" href="#">领域热点解读</a>
<span class="text-slate-300">/</span>
<span class="text-primary">AIGC行业</span>
</nav>
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
<h1 class="text-2xl font-bold tracking-tight text-slate-900">AIGC行业深度研判看板</h1>
<div class="flex flex-wrap gap-2">
<button class="flex items-center gap-2 px-5 py-2 bg-primary text-white hover:bg-primary/90 transition-colors rounded-lg font-bold text-sm">
...
<div class="bg-white p-4 rounded-xl custom-shadow mb-6 flex items-center gap-4 overflow-x-auto scrollbar-hide">
<button class="px-5 py-1.5 bg-primary text-white rounded-full text-sm font-bold whitespace-nowrap">AIGC行业</button>
<button class="px-5 py-1.5 text-slate-500 hover:bg-slate-50 rounded-full text-sm font-medium whitespace-nowrap">人形机器人</button>
<button class="px-5 py-1.5 text-slate-500 hover:bg-slate-50 rounded-full text-sm font-medium whitespace-nowrap">低空经济</button>
<button class="px-5 py-1.5 text-slate-500 hover:bg-slate-50 rounded-full text-sm font-medium whitespace-nowrap">新能源汽车</button>
<button class="px-5 py-1.5 text-slate-500 hover:bg-slate-50 rounded-full text-sm font-medium whitespace-nowrap">宠物行业</button>
<button class="px-5 py-1.5 text-slate-500 hover:bg-slate-50 rounded-full text-sm font-medium whitespace-nowrap">美妆</button>
</div>
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
<div class="bg-white p-5 rounded-xl custom-shadow border border-slate-50">
<div class="flex justify-between items-start mb-6">
<h3 class="text-sm font-bold text-slate-800">GPU进口量</h3>
<button class="text-[10px] text-primary bg-primary/10 px-2 py-0.5 rounded font-bold">指标详情</button>
</div>
<div class="h-28 flex items-end gap-1.5 mb-4">
<div class="flex-1 bg-primary/20 rounded-t-sm h-[40%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[55%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[45%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[70%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[65%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[85%]"></div>
...
<div class="bg-white p-5 rounded-xl custom-shadow border border-slate-50">
<div class="flex justify-between items-start mb-6">
<h3 class="text-sm font-bold text-slate-800">AIGC企业平均毛利率</h3>
<button class="text-[10px] text-primary bg-primary/10 px-2 py-0.5 rounded font-bold">指标详情</button>
</div>
<div class="h-28 flex items-end gap-1.5 mb-4">
<div class="flex-1 bg-primary/20 rounded-t-sm h-[60%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[62%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[58%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[65%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[68%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[63%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[70%]"></div>
</div>
<div class="flex justify-between text-[10px] text-slate-400">
<span>单位: %</span>
...
<div class="bg-white p-5 rounded-xl custom-shadow border border-slate-50">
<div class="flex justify-between items-start mb-6">
<h3 class="text-sm font-bold text-slate-800">数据中心平均PUE</h3>
<button class="text-[10px] text-primary bg-primary/10 px-2 py-0.5 rounded font-bold">指标详情</button>
</div>
<div class="h-28 flex items-end gap-1.5 mb-4 relative">
<svg class="w-full h-full" preserveAspectRatio="none" viewBox="0 0 100 100">
<path d="M0,80 L20,70 L40,75 L60,60 L80,50 L100,45" fill="none" stroke="#17b0cf" stroke-width="2"></path>
<path d="M0,80 L20,70 L40,75 L60,60 L80,50 L100,45 L100,100 L0,100 Z" fill="url(#grad1)" opacity="0.2"></path>
<defs>
<linearGradient id="grad1" x1="0%" x2="0%" y1="0%" y2="100%">
<stop offset="0%" style="stop-color:rgb(23,176,207);stop-opacity:1"></stop>
<stop offset="100%" style="stop-color:rgb(23,176,207);stop-opacity:0"></stop>
</linearGradient>
</defs>
</svg>
</div>
...
<div class="bg-white p-5 rounded-xl custom-shadow border border-slate-50">
<div class="flex justify-between items-start mb-6">
<h3 class="text-sm font-bold text-slate-800">数据中心电力成本指数</h3>
<button class="text-[10px] text-primary bg-primary/10 px-2 py-0.5 rounded font-bold">指标详情</button>
</div>
<div class="h-28 flex items-end gap-1.5 mb-4">
<div class="flex-1 bg-primary/20 rounded-t-sm h-[30%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[40%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[50%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[60%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[55%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[75%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[80%]"></div>
</div>
<div class="flex justify-between text-[10px] text-slate-400">
<span>单位: 点</span>
...
<div class="bg-white p-5 rounded-xl custom-shadow border border-slate-50">
<div class="flex justify-between items-start mb-6">
<h3 class="text-sm font-bold text-slate-800">GPU渠道库存周转天数</h3>
<button class="text-[10px] text-primary bg-primary/10 px-2 py-0.5 rounded font-bold">指标详情</button>
</div>
<div class="h-28 flex items-end gap-1.5 mb-4 relative">
<svg class="w-full h-full" preserveAspectRatio="none" viewBox="0 0 100 100">
<path d="M0,50 L20,55 L40,45 L60,40 L80,35 L100,30" fill="none" stroke="#17b0cf" stroke-width="2"></path>
</svg>
</div>
<div class="flex justify-between text-[10px] text-slate-400">
<span>单位: 天</span>
...
<div class="bg-white p-5 rounded-xl custom-shadow border border-slate-50">
<div class="flex justify-between items-start mb-6">
<h3 class="text-sm font-bold text-slate-800">数据中心GPU利用率</h3>
<button class="text-[10px] text-primary bg-primary/10 px-2 py-0.5 rounded font-bold">指标详情</button>
</div>
<div class="h-28 flex items-end gap-1.5 mb-4">
<div class="flex-1 bg-primary/20 rounded-t-sm h-[40%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[42%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[45%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[50%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[55%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[60%]"></div>
...
<div class="bg-white p-5 rounded-xl custom-shadow border border-slate-50">
<div class="flex justify-between items-start mb-6">
<h3 class="text-sm font-bold text-slate-800">生成式AI行业市场规模</h3>
<button class="text-[10px] text-primary bg-primary/10 px-2 py-0.5 rounded font-bold">指标详情</button>
</div>
<div class="h-28 flex items-end gap-1.5 mb-4">
<div class="flex-1 bg-primary/20 rounded-t-sm h-[10%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[15%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[20%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[35%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[55%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[80%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[95%]"></div>
</div>
<div class="flex justify-between text-[10px] text-slate-400">
<span>单位: 亿元</span>
...
<div class="bg-white p-5 rounded-xl custom-shadow border border-slate-50">
<div class="flex justify-between items-start mb-6">
<h3 class="text-sm font-bold text-slate-800">AIGC行业投融资金额</h3>
<button class="text-[10px] text-primary bg-primary/10 px-2 py-0.5 rounded font-bold">指标详情</button>
</div>
<div class="h-28 flex items-end gap-1.5 mb-4">
<div class="flex-1 bg-primary/20 rounded-t-sm h-[30%]"></div>
...
<div class="flex-1 bg-primary/20 rounded-t-sm h-[85%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[75%]"></div>
<div class="flex-1 bg-primary/20 rounded-t-sm h-[90%]"></div>
</div>
<div class="flex justify-between text-[10px] text-slate-400">
<span>单位: 亿元</span>
<span>数据来源: IT桔子</span>
...
<div class="bg-white rounded-xl custom-shadow overflow-hidden border border-slate-50">
<div class="p-5">
<div class="flex items-center gap-2 mb-4">
<div class="w-1 h-4 bg-primary rounded-full"></div>
<h2 class="font-bold text-slate-800">相关政策</h2>
</div>
<div class="space-y-4 mb-8">
<div class="flex justify-between items-center group cursor-pointer">
<span class="text-sm text-slate-600 group-hover:text-primary transition-colors">《生成式人工智能服务管理暂行办法》落地实施方案</span>
<span class="text-xs text-slate-400">2024-03-15</span>
</div>
<div class="flex justify-between items-center group cursor-pointer">
<span class="text-sm text-slate-600 group-hover:text-primary transition-colors">关于促进人工智能产业高质量发展的指导意见</span>
<span class="text-xs text-slate-400">2024-02-28</span>
</div>
<div class="flex justify-between items-center group cursor-pointer">
<span class="text-sm text-slate-600 group-hover:text-primary transition-colors">国家算力枢纽节点建设规划纲要 (2024-2026)</span>
<span class="text-xs text-slate-400">2024-01-20</span>
</div>
</div>
<div class="flex items-center gap-2 mb-4">
<div class="w-1 h-4 bg-primary rounded-full"></div>
<h2 class="font-bold text-slate-800">相关研报 - 月度推荐</h2>
</div>
<div class="space-y-4">
<div class="flex justify-between items-start group cursor-pointer">
<div>
<h4 class="text-sm font-bold text-slate-800 group-hover:text-primary transition-colors">从AIGC到AIGD：智能决策的下一站</h4>
<p class="text-[10px] text-slate-400 mt-1">明略科技研究院 · 行业研究</p>
</div>
<span class="text-xs text-slate-400">2024-03-01</span>
</div>
<div class="flex justify-between items-start group cursor-pointer">
<div>
<h4 class="text-sm font-bold text-slate-800 group-hover:text-primary transition-colors">2024年AIGC行业现状及发展趋势白皮书</h4>
<p class="text-[10px] text-slate-400 mt-1">AIGCLink研究院 · 行业研究</p>
</div>
<span class="text-xs text-slate-400">2024-02-15</span>
</div>
</div>
</div>
</div>
...
<div class="flex items-center gap-2 mb-4">
<div class="w-1 h-4 bg-primary rounded-full"></div>
<h2 class="font-bold text-slate-800">相关新闻</h2>
</div>
<div class="space-y-4 mb-8">
<div class="flex justify-between items-center group cursor-pointer">
<span class="text-sm text-slate-600 group-hover:text-primary transition-colors">大模型驱动下，AI算力基础设施行业迎来黄金发展期</span>
<span class="text-xs text-slate-400">2024-03-20</span>
</div>
<div class="flex justify-between items-center group cursor-pointer">
<span class="text-sm text-slate-600 group-hover:text-primary transition-colors">万卡大算力+万亿大模型：中国AI新叙事</span>
<span class="text-xs text-slate-400">2024-03-18</span>
</div>
<div class="flex justify-between items-center group cursor-pointer">
<span class="text-sm text-slate-600 group-hover:text-primary transition-colors">英伟达发布全新B200芯片，性能提升5倍</span>
<span class="text-xs text-slate-400">2024-03-17</span>
</div>
</div>
<div class="flex items-center gap-2 mb-4">
<div class="w-1 h-4 bg-primary rounded-full"></div>
<h2 class="font-bold text-slate-800">相关研报 - 最新推荐</h2>
</div>
<div class="space-y-4">
<div class="flex justify-between items-start group cursor-pointer">
<div>
<h4 class="text-sm font-bold text-slate-800 group-hover:text-primary transition-colors">2025智绘未来：AIGC应用赋能千行百业发展报告</h4>
<p class="text-[10px] text-slate-400 mt-1">人民网研究院 · 行业研究</p>
</div>
<span class="text-xs text-slate-400">2024-03-19</span>
</div>
<div class="flex justify-between items-start group cursor-pointer">
<div>
<h4 class="text-sm font-bold text-slate-800 group-hover:text-primary transition-colors">传媒互联网周观点：Coding、Agent和AIGC多模态三大主线</h4>
<p class="text-[10px] text-slate-400 mt-1">浙商证券 · 行业研究</p>
</div>
<span class="text-xs text-slate-400">2024-03-18</span>
</div>
</div>
