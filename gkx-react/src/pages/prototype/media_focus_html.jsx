...
<!-- Main Content Area -->
<div class="mx-auto flex w-full max-w-[1440px] flex-1 flex-col px-6 py-8 md:px-10 lg:px-16">
<!-- Breadcrumbs -->
<nav class="flex flex-wrap items-center gap-2 mb-6">
<a class="text-primary/80 hover:text-primary text-sm font-medium transition-colors" href="#">新型高端智库系统</a>
<span class="text-slate-400 text-sm">/</span>
<a class="text-primary/80 hover:text-primary text-sm font-medium transition-colors" href="#">战略咨询智能支持</a>
<span class="text-slate-400 text-sm">/</span>
<a class="text-primary/80 hover:text-primary text-sm font-medium transition-colors" href="#">研究需求分析</a>
<span class="text-slate-400 text-sm">/</span>
<span class="text-slate-900 dark:text-slate-100 text-sm font-semibold">媒体聚焦</span>
</nav>
<!-- Header Section -->
<div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
<h1 class="text-4xl font-black tracking-tight text-slate-900 dark:text-slate-100">媒体聚焦</h1>
<div class="flex flex-wrap gap-3">
<button class="inline-flex items-center justify-center gap-2 px-4 py-2 bg-primary/10 text-primary border border-primary/20 rounded-lg text-sm font-bold hover:bg-primary/20 transition-all">
<span class="material-symbols-outlined text-lg">settings_input_antenna</span>
<span>突发监测配置</span>
</button>
<button class="inline-flex items-center justify-center gap-2 px-4 py-2 bg-primary/10 text-primary border border-primary/20 rounded-lg text-sm font-bold hover:bg-primary/20 transition-all">
...
<button class="inline-flex items-center justify-center gap-2 px-4 py-2 bg-primary text-white rounded-lg text-sm font-bold hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all">
...
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">监测资讯总数</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-white">128,429</span>
<span class="text-xs text-primary font-bold mb-1">+5.2%</span>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">今日热点事件</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-white">15</span>
<span class="px-2 py-0.5 rounded-full bg-red-100 text-red-600 text-[10px] font-bold mb-1">紧急</span>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">平均情感正向率</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-white">82.4%</span>
<div class="h-2 w-20 bg-slate-100 dark:bg-slate-700 rounded-full mb-2 overflow-hidden">
<div class="h-full bg-green-500 rounded-full" style="width: 82%"></div>
</div>
</div>
</div>
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
<p class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">媒体-技术耦合度均值</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-white">0.76</span>
<span class="text-xs text-slate-400 mb-1">高相关性</span>
</div>
</div>
</div>
...
<h3 class="text-lg font-bold">媒体提及与技术趋势耦合时序图</h3>
<div class="flex gap-2">
<span class="flex items-center gap-1 text-xs text-slate-500"><span class="w-3 h-3 rounded-full bg-primary"></span> 资讯量</span>
<span class="flex items-center gap-1 text-xs text-slate-500"><span class="w-3 h-3 rounded-full bg-green-500"></span> 情感值</span>
<span class="flex items-center gap-1 text-xs text-slate-500"><span class="w-3 h-3 rounded-full bg-purple-500"></span> 学术产出</span>
</div>
</div>
...
<div class="flex justify-between mt-4 text-[11px] text-slate-400 font-bold uppercase tracking-wider">
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden flex flex-col">
<h3 class="text-lg font-bold mb-4">热点突发检测</h3>
<div class="flex-1 overflow-y-auto space-y-4 pr-2 custom-scrollbar">
<div class="group p-3 rounded-lg bg-slate-50 dark:bg-slate-700/50 hover:bg-primary/5 transition-colors border border-transparent hover:border-primary/20">
<div class="flex justify-between items-start mb-2">
<span class="text-sm font-bold truncate pr-2">量子通信安全标准发布</span>
<span class="shrink-0 px-2 py-0.5 rounded-md bg-orange-100 text-orange-600 text-[10px] font-bold">高强度</span>
</div>
<div class="flex justify-between items-center">
<span class="text-xs text-slate-500">爆发指数: 94.2</span>
<button class="text-primary text-xs font-bold flex items-center gap-1">
<span class="material-symbols-outlined text-sm">add_circle</span>加入监控
                                </button>
</div>
</div>
<div class="group p-3 rounded-lg bg-slate-50 dark:bg-slate-700/50 hover:bg-primary/5 transition-colors border border-transparent hover:border-primary/20">
<div class="flex justify-between items-start mb-2">
<span class="text-sm font-bold truncate pr-2">硅光子芯片技术路线争议</span>
<span class="shrink-0 px-2 py-0.5 rounded-md bg-blue-100 text-blue-600 text-[10px] font-bold">中等</span>
</div>
<div class="flex justify-between items-center">
<span class="text-xs text-slate-500">爆发指数: 68.5</span>
<button class="text-primary text-xs font-bold flex items-center gap-1">
<span class="material-symbols-outlined text-sm">add_circle</span>加入监控
                                </button>
</div>
...
<div class="group p-3 rounded-lg bg-slate-50 dark:bg-slate-700/50 hover:bg-primary/5 transition-colors border border-transparent hover:border-primary/20">
<div class="flex justify-between items-start mb-2">
<span class="text-sm font-bold truncate pr-2">低轨卫星互联网频段分配</span>
<span class="shrink-0 px-2 py-0.5 rounded-md bg-orange-100 text-orange-600 text-[10px] font-bold">高强度</span>
</div>
<div class="flex justify-between items-center">
<span class="text-xs text-slate-500">爆发指数: 88.1</span>
<button class="text-primary text-xs font-bold flex items-center gap-1">
<span class="material-symbols-outlined text-sm">add_circle</span>加入监控
                                </button>
</div>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm relative overflow-hidden h-[500px] flex flex-col">
<div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 relative z-10">
<div>
<h3 class="text-lg font-bold">媒体—技术耦合关联网络</h3>
<p class="text-xs text-slate-500 mt-1">分析重点：关键核心技术与全球主流媒体报道链条</p>
</div>
<div class="flex flex-wrap gap-2">
<div class="flex bg-slate-100 dark:bg-slate-700 p-1 rounded-lg">
<button class="p-1.5 hover:bg-white dark:hover:bg-slate-600 rounded-md transition-all shadow-sm">
<span class="material-symbols-outlined text-xl">zoom_in</span>
</button>
<button class="p-1.5 hover:bg-white dark:hover:bg-slate-600 rounded-md transition-all">
<span class="material-symbols-outlined text-xl">zoom_out</span>
</button>
</div>
<button class="inline-flex items-center gap-2 px-3 py-1.5 bg-slate-100 dark:bg-slate-700 rounded-lg text-xs font-bold">
<span class="material-symbols-outlined text-lg">route</span> 路径查找
                            </button>
<button class="inline-flex items-center gap-2 px-3 py-1.5 bg-slate-100 dark:bg-slate-700 rounded-lg text-xs font-bold">
<span class="material-symbols-outlined text-lg">filter_alt</span> 关系强度过滤
                            </button>
</div>
</div>
<!-- Graph Visualization Container -->
<div class="flex-1 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 relative overflow-hidden flex items-center justify-center">
...
<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 rounded-full bg-primary/20 border-2 border-primary flex items-center justify-center animate-pulse">
<div class="w-24 h-24 rounded-full bg-primary text-white flex items-center justify-center text-center p-2 font-bold text-sm shadow-xl">生成式AI</div>
</div>
<!-- Orbiting Nodes -->
<div class="absolute top-1/4 left-1/4 w-20 h-20 rounded-full bg-white dark:bg-slate-700 border-2 border-green-400 flex items-center justify-center text-center p-2 text-[10px] font-bold shadow-lg">纽约时报</div>
<div class="absolute bottom-1/4 right-1/4 w-20 h-20 rounded-full bg-white dark:bg-slate-700 border-2 border-purple-400 flex items-center justify-center text-center p-2 text-[10px] font-bold shadow-lg">算力分配</div>
<div class="absolute top-1/3 right-1/3 w-16 h-16 rounded-full bg-white dark:bg-slate-700 border-2 border-orange-400 flex items-center justify-center text-center p-1 text-[10px] font-bold shadow-lg">伦理争论</div>
...
<div class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
<div class="flex justify-between items-center mb-6">
<h3 class="text-lg font-bold">耦合度分析矩阵</h3>
<span class="text-[10px] font-bold px-2 py-0.5 bg-slate-100 dark:bg-slate-700 rounded uppercase">Granger Causality</span>
</div>
<div class="grid grid-cols-6 gap-2">
<!-- Y-axis labels would go here, simplified to a grid -->
<div class="col-start-2 col-span-5 flex justify-between px-2 text-[10px] text-slate-400 font-bold mb-1">
<span>A</span><span>B</span><span>C</span><span>D</span><span>E</span>
</div>
<div class="flex flex-col justify-between py-2 text-[10px] text-slate-400 font-bold text-right pr-2">
<span>M1</span><span>M2</span><span>M3</span><span>M4</span><span>M5</span>
</div>
<div class="col-span-5 grid grid-cols-5 grid-rows-5 gap-2 h-[240px]">
<!-- Grid cells with varying opacity primary color -->
<div class="bg-primary/90 rounded shadow-sm"></div>
<div class="bg-primary/20 rounded shadow-sm"></div>
<div class="bg-primary/60 rounded shadow-sm"></div>
<div class="bg-primary/40 rounded shadow-sm"></div>
<div class="bg-primary/10 rounded shadow-sm"></div>
<div class="bg-primary/30 rounded shadow-sm"></div>
<div class="bg-primary/80 rounded shadow-sm"></div>
<div class="bg-primary/50 rounded shadow-sm"></div>
<div class="bg-primary/20 rounded shadow-sm"></div>
<div class="bg-primary/70 rounded shadow-sm"></div>
<div class="bg-primary/10 rounded shadow-sm"></div>
<div class="bg-primary/40 rounded shadow-sm"></div>
<div class="bg-primary/90 rounded shadow-sm"></div>
<div class="bg-primary/30 rounded shadow-sm"></div>
...
<div class="bg-primary/20 rounded shadow-sm"></div>
<div class="bg-primary/10 rounded shadow-sm"></div>
<div class="bg-primary/85 rounded shadow-sm"></div>
<div class="bg-primary/40 rounded shadow-sm"></div>
<div class="bg-primary/70 rounded shadow-sm"></div>
<div class="bg-primary/10 rounded shadow-sm"></div>
<div class="bg-primary/30 rounded shadow-sm"></div>
<div class="bg-primary/20 rounded shadow-sm"></div>
<div class="bg-primary/95 rounded shadow-sm"></div>
</div>
</div>
<div class="mt-4 flex items-center justify-end gap-2">
<span class="text-[10px] text-slate-400">弱相关</span>
<div class="h-2 w-32 bg-gradient-to-r from-primary/10 to-primary rounded-full"></div>
<span class="text-[10px] text-slate-400">强相关</span>
</div>
</div>
...
<h3 class="text-lg font-bold mb-6">预警动态</h3>
<div class="flex-1 space-y-6">
<div class="relative pl-6 before:absolute before:left-[3px] before:top-2 before:bottom-[-24px] before:w-[1px] before:bg-slate-200 dark:before:bg-slate-700 last:before:hidden">
<div class="absolute left-0 top-1.5 w-2 h-2 rounded-full bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.5)]"></div>
<div class="flex flex-col gap-1">
<div class="flex justify-between items-center">
<span class="text-xs font-bold text-slate-400">10:42 AM</span>
<span class="text-[10px] px-1.5 py-0.5 bg-red-100 text-red-600 rounded font-bold uppercase">Critical</span>
</div>
<p class="text-sm font-semibold text-slate-800 dark:text-slate-200">检测到海外社交媒体关于“6G卫星隐私”的非正常激增</p>
<div class="flex gap-4 mt-1">
<a class="text-xs text-primary font-bold hover:underline flex items-center gap-1" href="#">
<span class="material-symbols-outlined text-sm">history_edu</span> 回测验证
                                    </a>
<a class="text-xs text-primary font-bold hover:underline flex items-center gap-1" href="#">
<span class="material-symbols-outlined text-sm">find_in_page</span> 查看证据溯源
                                    </a>
</div>
</div>
</div>
<div class="relative pl-6 before:absolute before:left-[3px] before:top-2 before:bottom-[-24px] before:w-[1px] before:bg-slate-200 dark:before:bg-slate-700 last:before:hidden">
<div class="absolute left-0 top-1.5 w-2 h-2 rounded-full bg-primary/60"></div>
<div class="flex flex-col gap-1">
<div class="flex justify-between items-center">
<span class="text-xs font-bold text-slate-400">09:15 AM</span>
<span class="text-[10px] px-1.5 py-0.5 bg-blue-100 text-blue-600 rounded font-bold uppercase">Info</span>
</div>
<p class="text-sm font-semibold text-slate-800 dark:text-slate-200">《Nature》发表针对特定蛋白质折叠技术的新突破</p>
<div class="flex gap-4 mt-1">
<a class="text-xs text-primary font-bold hover:underline flex items-center gap-1" href="#">
<span class="material-symbols-outlined text-sm">history_edu</span> 回测验证
                                    </a>
...
<div class="flex flex-col gap-1">
<div class="flex justify-between items-center">
<span class="text-xs font-bold text-slate-400">昨天 18:30</span>
<span class="text-[10px] px-1.5 py-0.5 bg-blue-100 text-blue-600 rounded font-bold uppercase">Info</span>
</div>
<p class="text-sm font-semibold text-slate-800 dark:text-slate-200">主要智库关于“数据跨境流动”的共识达成初步报告</p>
<div class="flex gap-4 mt-1">
<a class="text-xs text-primary font-bold hover:underline flex items-center gap-1" href="#">
<span class="material-symbols-outlined text-sm">history_edu</span> 回测验证
                                    </a>
