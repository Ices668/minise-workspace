...
<span class="text-slate-400 dark:text-slate-500 material-symbols-outlined text-sm">chevron_right</span>
<a class="text-primary hover:opacity-80" href="#">战略咨询智能支持</a>
<span class="text-slate-400 dark:text-slate-500 material-symbols-outlined text-sm">chevron_right</span>
<a class="text-primary hover:opacity-80" href="#">研究需求分析</a>
<span class="text-slate-400 dark:text-slate-500 material-symbols-outlined text-sm">chevron_right</span>
<span class="text-slate-600 dark:text-slate-400">科技实体清单</span>
</nav>
<!-- Header -->
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
<h1 class="text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-50">科技实体清单</h1>
<div class="flex items-center gap-3">
<button class="flex items-center gap-2 px-5 py-2.5 bg-primary/10 text-primary hover:bg-primary/20 transition-colors rounded-lg font-semibold text-sm">
<span class="material-symbols-outlined text-[20px]">file_download</span>
                    一键导出报告
                </button>
<button class="flex items-center gap-2 px-5 py-2.5 bg-primary text-white hover:opacity-90 transition-opacity rounded-lg font-semibold text-sm">
<span class="material-symbols-outlined text-[20px]">add</span>
                    新建实体
                </button>
<button class="p-2.5 bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-300 dark:hover:bg-slate-700 rounded-lg transition-colors">
...
<div class="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-slate-200/60 dark:border-slate-800">
<p class="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">实体总数</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-white leading-none">1,284</span>
<span class="text-xs text-green-500 font-medium mb-1">+12%</span>
</div>
</div>
<div class="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-slate-200/60 dark:border-slate-800">
<p class="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">本月新增</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-white leading-none">56</span>
<span class="text-xs text-primary font-medium mb-1">活跃</span>
</div>
</div>
<div class="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-slate-200/60 dark:border-slate-800">
<p class="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">高创新指数占比</p>
<div class="flex items-end gap-2">
<span class="text-3xl font-bold text-slate-900 dark:text-white leading-none">32.4%</span>
<div class="w-24 h-2 bg-slate-100 dark:bg-slate-800 rounded-full mb-2 overflow-hidden">
<div class="bg-primary h-full w-[32.4%]"></div>
</div>
</div>
</div>
</div>
<!-- Filter Card -->
<div class="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-slate-200/60 dark:border-slate-800 mb-8">
<div class="flex flex-col gap-5">
<!-- Capsule Search -->
<div class="relative group">
<span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary material-symbols-outlined">search</span>
<input class="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-slate-800/50 border-none rounded-full focus:ring-2 focus:ring-primary/50 text-slate-900 dark:text-slate-100 placeholder:text-slate-400" placeholder="关键词模糊搜索（实体名称、简介、技术关键词）" type="text"/>
</div>
<!-- Dropdowns and Actions -->
<div class="flex flex-wrap items-center justify-between gap-4">
<div class="flex flex-wrap items-center gap-3">
<button class="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors text-sm font-medium">
                            技术领域 <span class="material-symbols-outlined text-sm">expand_more</span>
</button>
<button class="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors text-sm font-medium">
                            所属地区 <span class="material-symbols-outlined text-sm">expand_more</span>
</button>
<button class="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors text-sm font-medium">
                            创新指数 <span class="material-symbols-outlined text-sm">expand_more</span>
</button>
<button class="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors text-sm font-medium">
                            实体标签 <span class="material-symbols-outlined text-sm">expand_more</span>
</button>
</div>
<div class="flex items-center gap-2">
<button class="px-6 py-2 bg-primary text-white rounded-lg font-semibold text-sm hover:opacity-90">查询</button>
<button class="px-6 py-2 bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 rounded-lg font-semibold text-sm hover:bg-slate-300 dark:hover:bg-slate-700">重置</button>
</div>
</div>
</div>
</div>
...
<div class="flex items-center bg-slate-200/50 dark:bg-slate-800 p-1 rounded-lg">
<button class="p-1.5 rounded-md bg-white dark:bg-slate-700 shadow-sm text-primary">
<span class="material-symbols-outlined block">format_list_bulleted</span>
</button>
<button class="p-1.5 rounded-md text-slate-500 hover:text-slate-700 dark:hover:text-slate-300">
<span class="material-symbols-outlined block">grid_view</span>
</button>
</div>
<div class="flex items-center gap-3">
<button class="flex items-center gap-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">
...
<!-- Main Content Table -->
<div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200/60 dark:border-slate-800 overflow-hidden mb-6">
<div class="overflow-x-auto">
<table class="w-full text-left border-collapse">
<thead>
<tr class="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800">
<th class="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">实体名称</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">技术领域</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">创新指数</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">标签</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">更新时间</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-right">操作</th>
</tr>
</thead>
...
<div class="flex items-center gap-3">
<div class="w-8 h-8 rounded bg-primary/10 flex items-center justify-center text-primary font-bold text-xs">A</div>
<span class="font-semibold text-slate-900 dark:text-slate-100">先导微电子研究所</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600 dark:text-slate-400">半导体装备</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center gap-3">
<div class="flex-1 w-24 h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
<div class="bg-green-500 h-full w-[88%]"></div>
</div>
<span class="text-xs font-bold text-slate-700 dark:text-slate-300">88.5</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex gap-1.5">
<span class="px-2 py-0.5 bg-primary/10 text-primary text-[10px] font-bold rounded">核心实验室</span>
<span class="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 text-[10px] font-bold rounded">高新企业</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400">2023-11-20</td>
<td class="px-6 py-4 whitespace-nowrap text-right text-sm">
<div class="flex items-center justify-end gap-3">
<button class="text-primary hover:underline font-medium">详情</button>
<button class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 material-symbols-outlined text-[18px]">edit</button>
<button class="text-slate-400 hover:text-red-500 material-symbols-outlined text-[18px]">delete</button>
</div>
</td>
</tr>
<!-- Table Row 2 -->
...
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center gap-3">
<div class="w-8 h-8 rounded bg-primary/10 flex items-center justify-center text-primary font-bold text-xs">B</div>
<span class="font-semibold text-slate-900 dark:text-slate-100">量子信息科技实验室</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600 dark:text-slate-400">量子通信</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center gap-3">
<div class="flex-1 w-24 h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
<div class="bg-primary h-full w-[94%]"></div>
</div>
<span class="text-xs font-bold text-slate-700 dark:text-slate-300">94.2</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex gap-1.5">
<span class="px-2 py-0.5 bg-primary/10 text-primary text-[10px] font-bold rounded">国家级</span>
<span class="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 text-[10px] font-bold rounded">独角兽</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400">2023-11-18</td>
<td class="px-6 py-4 whitespace-nowrap text-right text-sm">
<div class="flex items-center justify-end gap-3">
<button class="text-primary hover:underline font-medium">详情</button>
<button class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 material-symbols-outlined text-[18px]">edit</button>
...
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center gap-3">
<div class="w-8 h-8 rounded bg-primary/10 flex items-center justify-center text-primary font-bold text-xs">C</div>
<span class="font-semibold text-slate-900 dark:text-slate-100">深海深地探测工程院</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600 dark:text-slate-400">能源科技</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center gap-3">
<div class="flex-1 w-24 h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
<div class="bg-yellow-500 h-full w-[72%]"></div>
</div>
<span class="text-xs font-bold text-slate-700 dark:text-slate-300">72.0</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex gap-1.5">
<span class="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 text-[10px] font-bold rounded">重点工程</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400">2023-11-15</td>
<td class="px-6 py-4 whitespace-nowrap text-right text-sm">
<div class="flex items-center justify-end gap-3">
<button class="text-primary hover:underline font-medium">详情</button>
<button class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 material-symbols-outlined text-[18px]">edit</button>
...
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center gap-3">
<div class="w-8 h-8 rounded bg-primary/10 flex items-center justify-center text-primary font-bold text-xs">D</div>
<span class="font-semibold text-slate-900 dark:text-slate-100">神经形态计算中心</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600 dark:text-slate-400">人工智能</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center gap-3">
<div class="flex-1 w-24 h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
<div class="bg-green-500 h-full w-[85%]"></div>
</div>
<span class="text-xs font-bold text-slate-700 dark:text-slate-300">85.9</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex gap-1.5">
<span class="px-2 py-0.5 bg-primary/10 text-primary text-[10px] font-bold rounded">前沿领域</span>
<span class="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 text-[10px] font-bold rounded">校企合作</span>
</div>
</td>
<td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400">2023-11-12</td>
<td class="px-6 py-4 whitespace-nowrap text-right text-sm">
<div class="flex items-center justify-end gap-3">
<button class="text-primary hover:underline font-medium">详情</button>
<button class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 material-symbols-outlined text-[18px]">edit</button>
...
<span class="text-slate-500 dark:text-slate-400 mr-4">共 1,284 条数据</span>
<button class="w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
<span class="material-symbols-outlined text-[18px]">chevron_left</span>
</button>
<button class="w-8 h-8 flex items-center justify-center rounded-lg bg-primary text-white font-bold">1</button>
<button class="w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">2</button>
<button class="w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">3</button>
<span class="px-2 text-slate-400">...</span>
<button class="w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">129</button>
<button class="w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
