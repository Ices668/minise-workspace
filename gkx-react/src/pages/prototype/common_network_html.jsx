...
// Source: gkx-prototype/common-network.html
...
<!-- Page Header -->
<div class="mb-8">
<h1 class="text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100">共性网络分析</h1>
<p class="mt-2 text-slate-600 dark:text-slate-400">深入分析技术术语关联及核心研究者贡献度</p>
</div>
<!-- Tabs Navigation -->
<div class="mb-8 border-b border-slate-200 dark:border-slate-800">
<div class="flex gap-8">
<button class="flex flex-col items-center justify-center border-b-2 border-primary pb-4 pt-2 group">
<div class="flex items-center gap-2">
<span class="material-symbols-outlined text-primary">hub</span>
<p class="text-sm font-bold text-slate-900 dark:text-slate-100">关系矩阵</p>
</div>
</button>
<button class="flex flex-col items-center justify-center border-b-2 border-transparent pb-4 pt-2 text-slate-500 hover:text-primary transition-colors">
<div class="flex items-center gap-2">
<span class="material-symbols-outlined">groups</span>
<p class="text-sm font-bold">核心研究者</p>
</div>
</button>
</div>
</div>
...
<h2 class="text-xl font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                术语关系矩阵
                <span class="px-2 py-0.5 rounded bg-primary/10 text-primary text-xs font-medium uppercase tracking-wider">实时分析</span>
</h2>
<!-- Capsule Search -->
...
<input class="block w-full pl-10 pr-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all" placeholder="搜索特定术语或关键词..." type="text"/>
</div>
</div>
<!-- Table Component -->
...
<th class="px-6 py-4 text-sm font-semibold text-slate-700 dark:text-slate-300">术语对</th>
<th class="px-6 py-4 text-sm font-semibold text-slate-700 dark:text-slate-300 text-center">共现频次</th>
<th class="px-6 py-4 text-sm font-semibold text-slate-700 dark:text-slate-300 text-center">语义相似度</th>
<th class="px-6 py-4 text-sm font-semibold text-slate-700 dark:text-slate-300 text-center">上下文相关度</th>
<th class="px-6 py-4 text-sm font-semibold text-slate-700 dark:text-slate-300">综合强度</th>
</tr>
</thead>
<tbody class="divide-y divide-slate-100 dark:divide-slate-800">
<tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
<td class="px-6 py-5 text-sm font-medium text-slate-900 dark:text-slate-100">人工智能 - 机器学习</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">1,240</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">0.89</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">0.82</td>
<td class="px-6 py-5">
...
<tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
<td class="px-6 py-5 text-sm font-medium text-slate-900 dark:text-slate-100">神经网络 - 深度学习</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">980</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">0.95</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">0.91</td>
<td class="px-6 py-5">
<div class="flex items-center gap-3">
<div class="flex-1 h-1.5 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden">
<div class="h-full bg-primary rounded-full" style="width: 93%"></div>
</div>
<span class="text-sm font-bold text-primary">93</span>
</div>
</td>
</tr>
<tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
<td class="px-6 py-5 text-sm font-medium text-slate-900 dark:text-slate-100">大数据 - 云计算</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">850</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">0.76</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">0.70</td>
<td class="px-6 py-5">
<div class="flex items-center gap-3">
<div class="flex-1 h-1.5 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden">
...
<tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
<td class="px-6 py-5 text-sm font-medium text-slate-900 dark:text-slate-100">边缘计算 - 物联网</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">620</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">0.82</td>
<td class="px-6 py-5 text-sm text-slate-600 dark:text-slate-400 text-center">0.78</td>
<td class="px-6 py-5">
<div class="flex items-center gap-3">
<div class="flex-1 h-1.5 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden">
<div class="h-full bg-primary rounded-full" style="width: 79%"></div>
</div>
<span class="text-sm font-bold text-primary">79</span>
</div>
</td>
</tr>
</tbody>
...
<h2 class="text-xl font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
            核心研究者识别
            <span class="text-slate-400 font-normal text-sm">(共 24 位核心研究者)</span>
</h2>
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
<!-- Researcher Card 1 -->
<div class="p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow">
<div class="flex items-start justify-between mb-4">
<div class="flex items-center gap-4">
<div class="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center border-2 border-primary/20">
<span class="material-symbols-outlined text-3xl text-primary">account_circle</span>
</div>
<div>
<h3 class="text-lg font-bold text-slate-900 dark:text-slate-100">张明远 教授</h3>
<p class="text-sm text-slate-500">清华大学 · 计算机科学与技术系</p>
</div>
</div>
<div class="text-right">
<div class="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-1">贡献值</div>
<div class="text-2xl font-black text-primary">98.4</div>
</div>
</div>
<div class="space-y-4">
<div class="flex flex-wrap gap-2">
<span class="px-2 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs rounded-md">自然语言处理</span>
<span class="px-2 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs rounded-md">大模型架构</span>
<span class="px-2 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs rounded-md">知识图谱</span>
</div>
<div class="border-t border-slate-100 dark:border-slate-800 pt-4">
<h4 class="text-xs font-bold text-slate-400 uppercase mb-3 flex items-center gap-2">
<span class="material-symbols-outlined text-sm">stars</span> 代表性成果
                        </h4>
<ul class="space-y-2">
<li class="text-sm text-slate-700 dark:text-slate-300 flex items-start gap-2">
<span class="material-symbols-outlined text-primary text-xs mt-1">description</span>
...
<div>
<h3 class="text-lg font-bold text-slate-900 dark:text-slate-100">李华 研究员</h3>
<p class="text-sm text-slate-500">中国科学院 · 软件研究所</p>
</div>
</div>
<div class="text-right">
<div class="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-1">贡献值</div>
<div class="text-2xl font-black text-primary">95.2</div>
</div>
</div>
<div class="space-y-4">
<div class="flex flex-wrap gap-2">
<span class="px-2 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs rounded-md">异构计算</span>
<span class="px-2 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs rounded-md">分布式存储</span>
<span class="px-2 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs rounded-md">云原生</span>
</div>
<div class="border-t border-slate-100 dark:border-slate-800 pt-4">
<h4 class="text-xs font-bold text-slate-400 uppercase mb-3 flex items-center gap-2">
<span class="material-symbols-outlined text-sm">stars</span> 代表性成果
...
<button class="px-6 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all flex items-center gap-2">
                加载更多研究者
