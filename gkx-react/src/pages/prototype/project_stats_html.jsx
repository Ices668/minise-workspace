...
<span class="text-slate-400">/</span>
<a class="text-primary hover:opacity-80" href="#">技术体系分析</a>
<span class="text-slate-400">/</span>
<span class="text-slate-600">科研项目分析</span>
</nav>
<div class="flex flex-wrap items-center justify-between gap-4 mb-8">
<h1 class="text-2xl font-black tracking-tight text-slate-900">科研项目分析</h1>
<div class="flex items-center gap-3">
<button class="flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl font-bold hover:opacity-90 transition-all shadow-sm">
<span class="material-symbols-outlined text-[20px]">add</span>
<span>新增分析任务</span>
</button>
<button class="flex items-center gap-2 px-5 py-2.5 bg-white text-slate-700 border border-slate-200 rounded-xl font-bold hover:bg-slate-50 transition-all shadow-sm">
<span class="material-symbols-outlined text-[20px]">download</span>
<span>导出数据</span>
</button>
<button class="flex items-center justify-center w-11 h-11 bg-white text-slate-700 border border-slate-200 rounded-xl hover:bg-slate-50 transition-all shadow-sm">
...
<a class="pb-4 text-primary font-bold border-b-2 border-primary relative" href="#">项目检索清单</a>
<a class="pb-4 text-slate-500 font-bold border-b-2 border-transparent hover:text-primary transition-colors" href="#">统计分析看板</a>
<a class="pb-4 text-slate-500 font-bold border-b-2 border-transparent hover:text-primary transition-colors" href="#">分析任务管理</a>
</div>
</div>
<div class="bg-white p-6 rounded-xl custom-shadow mb-6">
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
<div class="lg:col-span-2">
<label class="block text-xs font-bold text-slate-400 mb-2 uppercase tracking-wider">关键词检索</label>
<div class="relative">
<span class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">search</span>
<input class="w-full pl-11 pr-4 py-2.5 bg-slate-50 border-none rounded-full focus:ring-2 focus:ring-primary/20 text-sm" placeholder="搜索项目名称、负责人、关键词..." type="text"/>
</div>
</div>
<div>
<label class="block text-xs font-bold text-slate-400 mb-2 uppercase tracking-wider">技术领域</label>
<select class="w-full py-2.5 bg-slate-50 border-none rounded-lg focus:ring-2 focus:ring-primary/20 text-sm">
<option>全部领域</option>
<option>人工智能</option>
<option>生物医药</option>
<option>半导体</option>
...
<div>
<label class="block text-xs font-bold text-slate-400 mb-2 uppercase tracking-wider">资助来源</label>
<select class="w-full py-2.5 bg-slate-50 border-none rounded-lg focus:ring-2 focus:ring-primary/20 text-sm">
<option>全部来源</option>
...
<div>
<label class="block text-xs font-bold text-slate-400 mb-2 uppercase tracking-wider">项目状态</label>
<select class="w-full py-2.5 bg-slate-50 border-none rounded-lg focus:ring-2 focus:ring-primary/20 text-sm">
<option>进行中</option>
<option>已结题</option>
<option>启动中</option>
...
<div>
<label class="block text-xs font-bold text-slate-400 mb-2 uppercase tracking-wider">执行周期</label>
<input class="w-full py-2.5 bg-slate-50 border-none rounded-lg focus:ring-2 focus:ring-primary/20 text-sm" placeholder="选择日期范围" type="text"/>
</div>
<div class="flex gap-2">
<button class="flex-1 px-6 py-2.5 bg-primary text-white rounded-lg font-bold hover:opacity-90 transition-all">查询</button>
<button class="flex-1 px-6 py-2.5 bg-slate-100 text-slate-600 rounded-lg font-bold hover:bg-slate-200 transition-all">重置</button>
</div>
</div>
</div>
<div class="flex items-center justify-between mb-4">
<div class="flex items-center gap-4">
<div class="text-sm font-bold text-slate-700">实体数据列表 <span class="text-primary ml-1">1,248</span></div>
<div class="flex bg-white rounded-lg p-1 border border-slate-200">
<button class="p-1 text-primary bg-primary/10 rounded"><span class="material-symbols-outlined block text-[20px]">list</span></button>
<button class="p-1 text-slate-400 hover:text-slate-600"><span class="material-symbols-outlined block text-[20px]">grid_view</span></button>
</div>
</div>
<div class="flex items-center gap-3">
<button class="flex items-center gap-1.5 px-3 py-1.5 bg-white text-slate-600 border border-slate-200 rounded-lg text-sm font-bold hover:bg-slate-50">
...
<div class="bg-white rounded-xl custom-shadow overflow-hidden mb-6">
...
<th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">负责人</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">承担单位</th>
<th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">项目经费</th>
...
<span class="font-bold text-slate-900">生成式AI在药物发现中的应用</span>
</div>
</td>
<td class="px-6 py-4">
<div class="flex gap-2">
<span class="px-2 py-0.5 bg-blue-50 text-blue-600 text-[11px] font-bold rounded">人工智能</span>
<span class="px-2 py-0.5 bg-teal-50 text-teal-600 text-[11px] font-bold rounded">生物医药</span>
</div>
</td>
<td class="px-6 py-4">
<div class="text-sm">
<span class="font-bold text-slate-700">张文宏</span>
<span class="text-slate-400 ml-1">教授</span>
</div>
</td>
<td class="px-6 py-4 text-sm text-slate-600">复旦大学附属华山医院</td>
<td class="px-6 py-4 font-bold text-slate-900">1,250万</td>
<td class="px-6 py-4">
<span class="px-2.5 py-1 text-[11px] font-bold bg-emerald-50 text-emerald-600 rounded-full flex items-center w-fit gap-1">
...
<a class="text-primary text-sm font-bold hover:underline" href="#">查看详情</a>
<a class="text-primary text-sm font-bold hover:underline" href="#">关联分析</a>
</div>
</td>
</tr>
<tr class="hover:bg-slate-50/50 transition-colors">
...
<div class="flex items-center gap-2">
<span class="material-symbols-outlined text-primary text-[20px]">description</span>
<span class="font-bold text-slate-900">2nm制程关键设备研发专项</span>
</div>
</td>
<td class="px-6 py-4">
<div class="flex gap-2">
<span class="px-2 py-0.5 bg-blue-50 text-blue-600 text-[11px] font-bold rounded">半导体制造</span>
</div>
</td>
<td class="px-6 py-4">
<div class="text-sm">
<span class="font-bold text-slate-700">林本坚</span>
<span class="text-slate-400 ml-1">院士</span>
</div>
</td>
<td class="px-6 py-4 text-sm text-slate-600">清华大学集成电路学院</td>
<td class="px-6 py-4 font-bold text-slate-900">4,800万</td>
<td class="px-6 py-4">
<span class="px-2.5 py-1 text-[11px] font-bold bg-sky-50 text-sky-600 rounded-full flex items-center w-fit gap-1">
...
<div class="flex items-center gap-2">
<span class="material-symbols-outlined text-primary text-[20px]">description</span>
<span class="font-bold text-slate-900">深海自主无人探测系统研究</span>
</div>
</td>
<td class="px-6 py-4">
<div class="flex gap-2">
<span class="px-2 py-0.5 bg-blue-50 text-blue-600 text-[11px] font-bold rounded">海洋装备</span>
<span class="px-2 py-0.5 bg-slate-50 text-slate-600 text-[11px] font-bold rounded">自动化</span>
</div>
</td>
<td class="px-6 py-4">
<div class="text-sm">
<span class="font-bold text-slate-700">王海峰</span>
<span class="text-slate-400 ml-1">研究员</span>
</div>
</td>
<td class="px-6 py-4 text-sm text-slate-600">中船重工第702研究所</td>
<td class="px-6 py-4 font-bold text-slate-900">850万</td>
<td class="px-6 py-4">
<span class="px-2.5 py-1 text-[11px] font-bold bg-amber-50 text-amber-600 rounded-full flex items-center w-fit gap-1">
...
<div class="flex items-center gap-2">
<span class="material-symbols-outlined text-primary text-[20px]">description</span>
<span class="font-bold text-slate-900">量子通信加密算法安全性演化</span>
</div>
</td>
<td class="px-6 py-4">
<div class="flex gap-2">
<span class="px-2 py-0.5 bg-blue-50 text-blue-600 text-[11px] font-bold rounded">量子计算</span>
</div>
</td>
<td class="px-6 py-4">
<div class="text-sm">
<span class="font-bold text-slate-700">潘建伟</span>
<span class="text-slate-400 ml-1">院士</span>
</div>
</td>
<td class="px-6 py-4 text-sm text-slate-600">中国科学技术大学</td>
<td class="px-6 py-4 font-bold text-slate-900">2,100万</td>
<td class="px-6 py-4">
<span class="px-2.5 py-1 text-[11px] font-bold bg-emerald-50 text-emerald-600 rounded-full flex items-center w-fit gap-1">
<span class="w-1.5 h-1.5 bg-emerald-500 rounded-full"></span>
                                        进行中
...
<button class="w-8 h-8 flex items-center justify-center rounded border border-slate-200 text-slate-400 hover:border-primary hover:text-primary transition-colors">
<span class="material-symbols-outlined text-[18px]">chevron_left</span>
</button>
<button class="w-8 h-8 flex items-center justify-center rounded bg-primary text-white">1</button>
<button class="w-8 h-8 flex items-center justify-center rounded border border-slate-200 text-slate-600 hover:border-primary hover:text-primary transition-colors">2</button>
<button class="w-8 h-8 flex items-center justify-center rounded border border-slate-200 text-slate-600 hover:border-primary hover:text-primary transition-colors">3</button>
<span class="px-2 text-slate-400">...</span>
<button class="w-8 h-8 flex items-center justify-center rounded border border-slate-200 text-slate-600 hover:border-primary hover:text-primary transition-colors">12</button>
<button class="w-8 h-8 flex items-center justify-center rounded border border-slate-200 text-slate-400 hover:border-primary hover:text-primary transition-colors">
