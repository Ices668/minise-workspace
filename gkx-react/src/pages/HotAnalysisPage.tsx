...
export default function HotAnalysisPage() {
  ...
  return (
    <div className="antialiased">
      ...
      <path d="M0 60 Q 100 20, 200 70 T 400 40 T 600 80 T 800 20 T 1440 60" fill="none" stroke="currentColor" strokeWidth="3"></path>
      </svg>
      </div>
      ...
      <line strokeWidth="1" x1="50%" x2="30%" y1="50%" y2="10%"></line>
      <line strokeWidth="1" x1="50%" x2="80%" y1="50%" y2="80%"></line>
      <line strokeWidth="1" x1="50%" x2="90%" y1="50%" y2="35%"></line>
      <line strokeWidth="1" x1="50%" x2="15%" y1="50%" y2="70%"></line>
      </svg>
      </div>
      </div>
